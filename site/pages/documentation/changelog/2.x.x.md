# 更新日志
### 2.0.5-beta.6
- 修复 Cascader 禁用项样式错误的问题

### 2.0.5-beta.5
- 修复 Table 在固定列存在滚动的时候 Table cell 会偏移的问题

### 2.0.5-beta.4
- Cascader 新增 disabled 动态更新能力

### 2.0.5-beta.3
- 修复 Table 组件在某些场景下报错 global is not defined 的问题

### 2.0.5-beta.2
- 修复 DatePicker 在 open 为 true 时渲染异常的问题(< 2.0.4)
- 修复 Table 在部分场景下可能导致 SimpleTable 死循环的问题(< 2.0.4)
