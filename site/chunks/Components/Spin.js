...
const api = '[{"title":"Spin","properties":[{"name":"style","tag":{"cn":"Spin external style","en":"Spin 元素扩展样式","default":"","version":""},"type":"CSSProperties "},{"name":"className","tag":{"cn":"Spin external class","en":"Spin 元素扩展 class","default":"","version":""},"type":"string "},{"name":"name","tag":{"cn":"类型","en":"type","default":"\\\"fading-circle\\\"","version":""},"type":"| \\\"default\\\"  | \\\"chasing-dots\\\"  | \\\"cube-grid\\\"  | \\\"double-bounce\\\"  | \\\"fading-circle\\\"  | \\\"four-dots\\\"  | \\\"plane\\\"  | \\\"pulse\\\"  | \\\"ring\\\"  | \\\"scale-circle\\\"  | \\\"three-bounce\\\"  | \\\"wave\\\"  | \\\"chasing-ring\\\" "},{"name":"tip","tag":{"cn":"提示文案","en":"custom tip","default":"","version":""},"type":"string | ReactElement<any, string | JSXElementConstructor<any>> "},{"name":"children","tag":{"cn":"作为包裹元素使用","en":"Spin has children","default":"","version":""},"type":"string | ReactElement<any, string | JSXElementConstructor<any>> "},{"name":"size","tag":{"cn":"尺寸","en":"size","default":"40","version":""},"type":"string | number "},{"name":"loading","tag":{"cn":"是否为加载中","en":"loading","default":"true","version":""},"type":"boolean "},{"name":"color","tag":{"cn":"颜色","en":"color","default":"#6c757d","version":""},"type":"string "}],"cn":"","en":""}]';
