...
const api = '[{"title":"Card","properties":[{"name":"collapsible","tag":{"cn":"是否可折叠，\\\"bottom\\\" 表示从下方点击折叠","en":"Whether can be collapsed，\\\"bottom\\\" can collaps on bottom","default":"false"},"type":"boolean | \\\"bottom\\\""},{"name":"collapsed","tag":{"cn":"是否折叠，用于受控状态","en":"Whether to be collapsed.","default":""},"type":"boolean"},{"name":"defaultCollapsed","tag":{"cn":"初始折叠状态（仅在 collapsible 为 true 时有效）","en":"Initial collapsed state","default":"true"},"type":"boolean"},{"name":"onCollapse","tag":{"cn":"折叠状态改变时回调事件","en":"Callback when collapsed state changed","default":""},"type":"(collapsed: boolean) => void"},{"name":"shadow","tag":{"cn":"是否显示阴影\\n \\\"hover\\\" - 鼠标移到元素上显示;\\n true - 总是显示;\\n false - 从不显示","en":"Whether to show the shadow.\\\"hover\\\" - Display it when the mouse is over the element.true - Always show, false - Never show","default":"false"},"type":"Boolean | \\\"hover\\\""},{"name":"id","tag":{"cn":"手风琴下控制展开的值","en":"Card.Accordion expand controlled key","default":""},"type":"any"},{"name":"children","tag":{"cn":"子元素","en":"children","default":""},"type":"ReactNode"},{"name":"forwardedRef","tag":{"cn":"获取 Card dom","en":"get Card dom","default":""},"type":"(el: HTMLDivElement) => void"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"resizable","tag":{"cn":"是否可以拖动大小","en":"Is it possible to drag the size","default":"false"},"type":"boolean | \\\"x\\\" | \\\"y\\\" | \\\"xy\\\""},{"name":"moveable","tag":{"cn":"是否可以拖拽移动","en":"Is it possible to drag and drop to move","default":"false"},"type":"boolean"}],"cn":"","en":""},{"title":"Card.Header","properties":[{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"align","tag":{"cn":"对齐方式","en":"align","default":""},"type":"\\\"left\\\" | \\\"center\\\" | \\\"right\\\""},{"name":"children","tag":{"cn":"子元素","en":"children","default":""},"type":"ReactNode"}],"cn":"","en":""},{"title":"Card.Body","properties":[{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"children","tag":{"cn":"子元素","en":"children","default":""},"type":"ReactNode"}],"cn":"","en":""},{"title":"Card.Footer","properties":[{"name":"align","tag":{"cn":"对齐方式","en":"align","default":""},"type":"\\\"left\\\" | \\\"center\\\" | \\\"right\\\""},{"name":"children","tag":{"cn":"children","en":"子元素","default":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"}],"cn":"","en":""},{"title":"Card.Accordion","properties":[{"name":"active","tag":{"cn":"打开的值，全关闭时为 null，用于受控状态。默认为索引，若Card设置id后则为id。","en":"Active value. It is -1 when fully closed. Used in controlled state. be id while Card.id setted","default":""},"type":"any"},{"name":"defaultActive","tag":{"cn":"默认打开的值，用于非受控状态。默认为索引，若Card设置id后则为id。","en":"The default active value for uncontrolled state, be id while Card.id setted","default":"0"},"type":"any"},{"name":"onChange","tag":{"cn":"面板打开回调","en":"The callback function when the panel is opened","default":""},"type":"(active: any) => void"},{"name":"children","tag":{"cn":"子元素","en":"children","default":""},"type":"ReactNode"}],"cn":"","en":""}]';
