...
const api = '[{"title":"Checkbox","properties":[{"name":"onChange","tag":{"en":"value chane callback","cn":"值改变回调函数"},"type":"(value: any, checked: boolean | \\\\\"indeterminate\\\\\", index?: number ) => void"},{"name":"value","tag":{"en":"If checked is not set, checked status is value === htmlValue","cn":"如果 checked 未设置，checked 状态为 value === htmlValue"},"type":"any"},{"name":"disabled","tag":{"en":"disable checkbox","cn":"是否禁用","default":"false"},"type":"boolean"},{"name":"size","tag":{"en":"size","cn":"尺寸","default":"\\\"default\\\"","override":"union"},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"children","tag":{"en":"content","cn":"内容"},"type":"ReactNode"},{"name":"checked","tag":{"en":"if not set, use (value === htmlValue).","cn":"checked 传入时为受控组件"},"type":"boolean | \\\\\"indeterminate\\\\\"| ((htmlValue: any) => boolean | \\\\\"indeterminate\\\\\")"},{"name":"beforeChange","tag":{"en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","cn":"值改变前的回调，当返回值不为空时将作为组件的新值","override":"(value: any , datum?: FormDatum) => any"},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"en":"rules validation callback","cn":"rules 校验回调"},"type":"(e?: Error ) => void"},{"name":"bind","tag":{"en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用"},"type":"string[]"},{"name":"defaultValue","tag":{"en":"defaultValue","cn":"默认值","override":"any"},"type":"any"},{"name":"reserveAble","tag":{"en":"If set to true, the form will not automatically delete the data after the component is uninstalled","cn":"设置为true 组件卸载后表单不自动删除数据"},"type":"boolean"},{"name":"rules","tag":{"en":"Validation rules, see Rule usage for details","cn":"校验规则 详见 Rule 用法","override":"RuleItem[]"},"type":"RuleItem[]"},{"name":"name","tag":{"en":"Form field, used with Form","cn":"表单字段,配合 Form 使用"},"type":"string | string[]"},{"name":"inputable","tag":{"en":"Show input","cn":"开启后出现输入框","default":"false"},"type":"boolean"},{"name":"htmlValue","tag":{"en":"Specifies the result","cn":"选中时返回值","default":"true"},"type":"any"},{"name":"onClick","tag":{"en":"Checkbox click callback","cn":"勾选框点击回调","default":"false"},"type":"MouseEventHandler<HTMLInputElement>"}]},{"title":"Checkbox.Group","properties":[{"name":"onChange","tag":{"en":"值改变回调","cn":"value change callback"},"type":"(value: Value) => void"},{"name":"value","tag":{"en":"In the Form, the value will be taken over by the form and the value will lose efficacy.","cn":"在Form中，value会被表单接管，value无效","override":"any"},"type":"any"},{"name":"separator","tag":{"en":"set with multiple, value will separator by this","cn":"多选情况下设置后，value 会处理为 separator 分隔的字符串。"},"type":"string"},{"name":"prediction","tag":{"en":"By default, the result of the format function is used to compare whether it matches. In some cases (for example, whe an object that returns the original data is updated, an different option with the same value  is generated), the prediction function needs to be used to determine whether match","cn":"(val, d) => val===format(d) | 默认使用 format 函数执行的结果来比较是否匹配，在某些情况下（例如返回原始数据的对象，更新数据时，生成了一个值相同，非同一个对象的选项），需要借助 prediction 函数来判断是否匹配","default":"(val, d) => val===format(d)"},"type":"(value: Value extends (infer U)[] ? U : Value, data: DataItem) => boolean"},{"name":"disabled","tag":{"en":"When the value is true, disabled all checkboxes; When the value is function, disable the checkbox that this function returns true.","cn":"如果 disabled 为 true，禁用全部选项，如果 disabled 为函数，根据函数反回结果禁用选项","default":"false","override":"((data: Item) => boolean) | boolean"},"type":"((data: Item) => boolean) | boolean"},{"name":"format","tag":{"en":"Format value. The defaule value is return the original data. When it is a string, the value is fetched from the original data as a key equivalent to (d) => d[format] When it is a function, use its return value.","cn":"格式化 value。 默认值，返回原始数据。 为string时，会作为key从原始数据中获取值，相当于 (d) => d[format]。为函数时，以函数返回结果作为 value。","default":": d => d","override":"ObjectKey<Item> | ((data: Item) => Value extends (infer U)[] ? U : Value)"},"type":"ObjectKey<Item> | ((data: Item) => Value extends (infer U)[] ? U : Value)"},{"name":"data","tag":{"en":"data","cn":"数据项","override":"any[]"},"type":"any[]"},{"name":"keygen","tag":{"en":"Key generator\\nWhen it is true, the data itself is used as the key equivalent to (d => d)\\nWhen it is a function, use its return value.\\nWhen it is a string，ues the value of the string.For example, \\\"id\\\" is the same thing as (d) => d.id.","cn":"生成每一项key的辅助方法\\n为 true 时，以数据项本身作为key，相当于 (d => d)\\n为函数时，使用此函数返回值\\n为string时，使用这个string对应的数据值。如 \\\"id\\\"，相当于 (d => d.id)"},"type":"ObjectKey<DataItem> | ((data: DataItem, index?: number) => KeygenResult) | true"},{"name":"renderItem","tag":{"en":"When it is a string, return d[string]. When it is a function, return the result of the function.","cn":"为 string 时，返回 d[string]。 为 function 时，返回函数结果","default":"d => d"},"type":"ObjectKey<DataItem>| ((data: DataItem, index?: number ) => ReactNode)"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"children","tag":{"en":"Checkbox instance","cn":"Checkbox 实例"},"type":"ReactNode"},{"name":"beforeChange","tag":{"en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","cn":"值改变前的回调，当返回值不为空时将作为组件的新值","override":"(value: any , datum?: FormDatum) => any"},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"en":"rules validation callback","cn":"rules 校验回调"},"type":"(e?: Error ) => void"},{"name":"bind","tag":{"en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用"},"type":"string[]"},{"name":"defaultValue","tag":{"en":"defaultValue","cn":"默认值","override":"any"},"type":"any"},{"name":"reserveAble","tag":{"en":"If set to true, the form will not automatically delete the data after the component is uninstalled","cn":"设置为true 组件卸载后表单不自动删除数据"},"type":"boolean"},{"name":"rules","tag":{"en":"Validation rules, see Rule usage for details","cn":"校验规则 详见 Rule 用法","override":"RuleItem[]"},"type":"RuleItem[]"},{"name":"name","tag":{"en":"Form field, used with Form","cn":"表单字段,配合 Form 使用"},"type":"string | string[]"},{"name":"block","tag":{"en":"The default is horizontal layout, and setting the block property can change it to be vertical layout.","cn":"垂直布局","default":"false"},"type":"boolean"}]}]';
