...
const api = '[{"title":"Slider","properties":[{"name":"value","tag":{"cn":"当前值","en":"current value","default":"","version":""},"type":"Value "},{"name":"onChange","tag":{"cn":"值改变时回调函数","en":"Drag over the maximum event","default":"[0, 100]","version":""},"type":"(value: Value) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"type":"((e?: Error ) => void) "},{"name":"disabled","tag":{"cn":"是否禁用组件","en":"Disable component","default":"false","version":""},"type":"boolean "},{"name":"filterSameChange","tag":{"cn":"当两次选择的值相同时不触发onChange","en":"onChange is not triggered when two selected values are the same","default":"false","version":""},"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值","en":"default value","default":"","version":""},"type":"Value "},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 Rule 用法","en":"Validation rules, see Rule usage for details","default":"","version":""},"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段,配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"type":"string | string[] "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "},{"name":"height","tag":{"cn":"高度，仅在 vertical 为 true 情况下有效","en":"height. Only effect when vertical is true","default":"200","version":""},"type":"number "},{"name":"range","tag":{"cn":"是否显示双滑块","en":"Whether to display double slider","default":"false","version":""},"type":"boolean "},{"name":"vertical","tag":{"cn":"是否垂直","en":"Whether to be vertical","default":"false","version":""},"type":"boolean "},{"name":"step","tag":{"cn":"步长，必须大于等于0；为0时，只能选取 scale 指定的值","en":"Step size. Must be greater than or equal to 0; When it is 0, only the value specified by scale can be selected.","default":"1","version":""},"type":"number "},{"name":"autoHide","tag":{"cn":"是否自动隐藏当前值和刻度","en":"Automatically hides the current value and scale","default":"false","version":""},"type":"boolean "},{"name":"formatScale","tag":{"cn":"格式化显示刻度，为false时，不显示刻度","en":"Format displayed scale. When it is false, the scale is not displayed.","default":"v => v","version":""},"type":"false | ((value: number, index?: number ) => string | number) "},{"name":"formatValue","tag":{"cn":"格式化显示当前值，为false时，不显示当前值","en":"Format displayed current value. When it is false, the current value is not displayed.","default":"","version":""},"type":"false | ((value: number) => string) "},{"name":"scale","tag":{"cn":"取值范围，长度 >= 2 的数组","en":"Value range. An array whose length is greater than 2.","default":"[0, 100]","version":""},"type":"number[] "},{"name":"onIncrease","tag":{"cn":"拖动超过最大值事件","en":"Drag over the maximum event","default":"","version":""},"type":"(() => void) "}],"cn":"","en":""}]';
