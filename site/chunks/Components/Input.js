...
const api = '[{"title":"Input","properties":[{"name":"value","tag":{"cn":"输入值","en":"value","default":"","version":""},"required":false,"type":"string "},{"name":"onChange","tag":{"cn":"值改变回调","en":"onChange","default":"","version":""},"required":false,"type":"(value?: string ) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"required":false,"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"required":false,"type":"((e?: Error ) => void) "},{"name":"popover","tag":{"cn":"信息弹出位置，参考 [Popover](/components/Popover)","en":"The position where the text pop up, see [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"cn":"禁用组件","en":"Disable component","default":"false","version":""},"required":false,"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"required":false,"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值","en":"default value","default":"","version":""},"required":false,"type":"string "},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"required":false,"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 [Rule](/components/rule)","en":"Validation rules, see [Rule](/components/rule) usage for details","default":"","version":""},"required":false,"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段, 配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"required":false,"type":"string "},{"name":"size","tag":{"cn":"尺寸","en":"size","default":"\\\"default\\\"","version":""},"required":false,"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"htmlName","tag":{"cn":"原生html属性","en":"The original property of html","default":"","version":""},"required":false,"type":"string "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "},{"name":"placeholder","tag":{"cn":"同原生 input 标签的 placeholder","en":"Same as the native input tag","default":"","version":""},"required":false,"type":"string "},{"name":"autoFocus","tag":{"cn":"是否自动获得焦点","en":"Whether to automatically get the focus","default":"false","version":""},"required":false,"type":"boolean "},{"name":"type","tag":{"cn":"同原生 input 标签的 type","en":"Same as the type of the native input tag","default":"\\\"text\\\"","version":""},"required":false,"type":"string "},{"name":"onFocus","tag":{"cn":"聚焦后的回调","en":"The callback when Textarea focus","default":"","version":""},"required":false,"type":"FocusEventHandler<Element>"},{"name":"onBlur","tag":{"cn":"失去焦点后的回调","en":"The callback of blur","default":"","version":""},"required":false,"type":"FocusEventHandler<Element>"},{"name":"onKeyDown","tag":{"cn":"键盘按下回调","en":"The callback function for key down","default":"","version":""},"required":false,"type":"((e: KeyboardEvent<Element>) => void) "},{"name":"onKeyUp","tag":{"cn":"键盘按下后抬起的回调","en":"The callback function for key up","default":"","version":""},"required":false,"type":"((e: KeyboardEvent<Element>) => void) "},{"name":"info","tag":{"cn":"提示信息","en":"Infomation","default":"","version":""},"required":false,"type":"number | ((msg: string) => string) "},{"name":"tip","tag":{"cn":"提示信息","en":"Prompt information","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"width","tag":{"cn":"宽度","en":"width","default":"","version":""},"required":false,"type":"number "},{"name":"popoverProps","tag":{"cn":"校验弹框接受的属性，具体属性参考 [Popover](/components/Popover)","en":"Vilidate popup properties, specific properties refer to [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps "},{"name":"underline","tag":{"cn":"仅仅展示下边框","en":"show border bottom","default":"false","version":""},"required":false,"type":"boolean "},{"name":"border","tag":{"cn":"是否展示边框","en":"Whether to display border","default":"false","version":""},"required":false,"type":"boolean "},{"name":"innerTitle","tag":{"cn":"内嵌标题","en":"inner title","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"clearable","tag":{"cn":"可点击清空图标删除输入框内容，为函数式表示清空回调","en":"Remove content of the input when clicking the clear icon, clear event function","default":"false","version":""},"required":false,"type":"boolean | (() => void) "},{"name":"trim","tag":{"cn":"trim 为 true 时，失去焦点时会自动删除空白字符。","en":"When trim is true, blank characters are automatically deleted when lose focus。","default":"false","version":""},"required":false,"type":"boolean "},{"name":"delay","tag":{"cn":"用户输入触发 onChange 和校验间隔时间，单位 毫秒。","en":"User input triggers the onChange and to check interval, unit: ms.","default":"400","version":""},"required":false,"type":"number "},{"name":"placeTitle","tag":{"cn":"占位标题，需要配合 innerTitle 一起使用","en":"Placeholder title, which needs to be used together with innerTitle","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"coin","tag":{"cn":"以千位分隔符展示,仅当type为number时有效","en":"Show as thousands separator, valid only when type is \\\"number\\\"","default":"false","version":""},"required":false,"type":"boolean "},{"name":"onEnterPress","tag":{"cn":"回车键回调函数","en":"The callback function for enter key","default":"","version":""},"required":false,"type":"((value: string, e?: any) => void) "},{"name":"maxLength","tag":{"cn":"可输入最大长度","en":"input max length","default":"","version":""},"required":false,"type":"number "},{"name":"forwardedRef","tag":{"cn":"获取 input dom 元素","en":"get input element","default":"","version":""},"required":false,"type":"((el: HTMLElement) => void) "},{"name":"clearToUndefined","tag":{"cn":"点击清除按钮后数据变为 undefined","en":"After clicking the clear button, the data becomes undefined","default":"false","version":""},"required":false,"type":"boolean "},{"name":"digits","tag":{"cn":"小数位限制(type 为 number 时生效)","en":"Decimal place limit (valid when type is number)","default":"","version":""},"required":false,"type":"number "},{"name":"integerLimit","tag":{"cn":"整数位数限制, 仅在type = number 下生效","en":"Integer bit limit (valid when type is number)","default":"","version":""},"required":false,"type":"number "},{"name":"numType","tag":{"cn":"设置数字类型 支持 \\\"positive\\\" 和 \\\"non-negative\\\", 仅在type = number 下生效","en":"Number type supports \\\"positive\\\" and \\\"non-negative\\\", only works when type = number","default":"","version":""},"required":false,"type":"\\\"positive\\\" | \\\"non-negative\\\" "},{"name":"autoSelect","tag":{"cn":"鼠标点击后自动全选数据","en":"Automatically select all data after mouse click","default":"false","version":""},"required":false,"type":"boolean "},{"name":"autoFix","tag":{"cn":"失焦后自动按照 digits 精度限制补足 (type 为 number 时生效)","en":"Automatically fill up according to the precision limit of digits after out of focus","default":"false","version":""},"required":false,"type":"boolean "}],"cn":"","en":""},{"title":"Input.Number","properties":[{"name":"value","tag":{"cn":"值","en":"value","default":"","version":""},"required":false,"type":"InputValue | number | null "},{"name":"onChange","tag":{"cn":"值改变回调","en":"onChange","default":"","version":""},"required":false,"type":"(value?: InputValue | number | null ) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"required":false,"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"required":false,"type":"((e?: Error ) => void) "},{"name":"popover","tag":{"cn":"信息弹出位置，参考 [Popover](/components/Popover)","en":"The position where the text pop up, see [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"cn":"禁用组件","en":"Disable component","default":"false","version":""},"required":false,"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"required":false,"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值","en":"default value","default":"","version":""},"required":false,"type":"InputValue | number | null "},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"required":false,"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 [Rule](/components/rule)","en":"Validation rules, see [Rule](/components/rule) usage for details","default":"","version":""},"required":false,"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段, 配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"required":false,"type":"string "},{"name":"size","tag":{"cn":"尺寸","en":"size","default":"\\\"default\\\"","version":""},"required":false,"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"htmlName","tag":{"cn":"原生html属性","en":"The original property of html","default":"","version":""},"required":false,"type":"string "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "},{"name":"placeholder","tag":{"cn":"同原生 input 标签的 placeholder","en":"Same as the native input tag","default":"","version":""},"required":false,"type":"string "},{"name":"autoFocus","tag":{"cn":"是否自动获得焦点","en":"Whether to automatically get the focus","default":"false","version":""},"required":false,"type":"boolean "},{"name":"onFocus","tag":{"cn":"聚焦后的回调","en":"The callback when Textarea focus","default":"","version":""},"required":false,"type":"FocusEventHandler<Element>"},{"name":"onBlur","tag":{"cn":"失去焦点后的回调","en":"The callback of blur","default":"","version":""},"required":false,"type":"FocusEventHandler<Element>"},{"name":"onKeyDown","tag":{"cn":"键盘按下回调","en":"The callback function for key down","default":"","version":""},"required":false,"type":"((e: KeyboardEvent<Element>) => void) "},{"name":"onKeyUp","tag":{"cn":"键盘按下后抬起的回调","en":"The callback function for key up","default":"","version":""},"required":false,"type":"((e: KeyboardEvent<Element>) => void) "},{"name":"onMouseDown","tag":{"cn":"鼠标按下后的回调","en":"The callback function for mouse down","default":"","version":""},"required":false,"type":"((e: MouseEvent<Element, MouseEvent>) => void) "},{"name":"onMouseUp","tag":{"cn":"鼠标按下后抬起的回调","en":"The callback function for mouse up","default":"","version":""},"required":false,"type":"((e: MouseEvent<Element, MouseEvent>) => void) "},{"name":"info","tag":{"cn":"提示信息","en":"Infomation","default":"","version":""},"required":false,"type":"number | ((msg: string) => string) "},{"name":"tip","tag":{"cn":"提示信息","en":"Prompt information","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"width","tag":{"cn":"宽度","en":"width","default":"","version":""},"required":false,"type":"number "},{"name":"popoverProps","tag":{"cn":"校验弹框接受的属性，具体属性参考 [Popover](/components/Popover)","en":"Vilidate popup properties, specific properties refer to [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps "},{"name":"underline","tag":{"cn":"仅仅展示下边框","en":"show border bottom","default":"false","version":""},"required":false,"type":"boolean "},{"name":"border","tag":{"cn":"是否展示边框","en":"Whether to display border","default":"false","version":""},"required":false,"type":"boolean "},{"name":"innerTitle","tag":{"cn":"内嵌标题","en":"inner title","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"clearable","tag":{"cn":"可点击清空图标删除输入框内容，为函数式表示清空回调","en":"Remove content of the input when clicking the clear icon, clear event function","default":"false","version":""},"required":false,"type":"boolean | (() => void) "},{"name":"trim","tag":{"cn":"trim 为 true 时，失去焦点时会自动删除空白字符。","en":"When trim is true, blank characters are automatically deleted when lose focus。","default":"false","version":""},"required":false,"type":"boolean "},{"name":"min","tag":{"cn":"最小值","en":"The minimum value","default":"","version":""},"required":false,"type":"number "},{"name":"max","tag":{"cn":"最大值","en":"The maximum value","default":"","version":""},"required":false,"type":"number "},{"name":"placeTitle","tag":{"cn":"占位标题，需要配合 innerTitle 一起使用","en":"Placeholder title, which needs to be used together with innerTitle","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"coin","tag":{"cn":"以千位分隔符展示,仅当type为number时有效","en":"Show as thousands separator, valid only when type is \\\"number\\\"","default":"false","version":""},"required":false,"type":"boolean "},{"name":"onEnterPress","tag":{"cn":"回车键回调函数","en":"The callback function for enter key","default":"","version":""},"required":false,"type":"((value: string, e?: any) => void) "},{"name":"maxLength","tag":{"cn":"可输入最大长度","en":"input max length","default":"","version":""},"required":false,"type":"number "},{"name":"forwardedRef","tag":{"cn":"获取 input dom 元素","en":"get input element","default":"","version":""},"required":false,"type":"((el: HTMLElement) => void) "},{"name":"clearToUndefined","tag":{"cn":"点击清除按钮后数据变为 undefined","en":"After clicking the clear button, the data becomes undefined","default":"false","version":""},"required":false,"type":"boolean "},{"name":"digits","tag":{"cn":"小数位限制(type 为 number 时生效)","en":"Decimal place limit (valid when type is number)","default":"","version":""},"required":false,"type":"number "},{"name":"integerLimit","tag":{"cn":"整数位数限制, 仅在type = number 下生效","en":"Integer bit limit (valid when type is number)","default":"","version":""},"required":false,"type":"number "},{"name":"numType","tag":{"cn":"设置数字类型 支持 \\\"positive\\\" 和 \\\"non-negative\\\", 仅在type = number 下生效","en":"Number type supports \\\"positive\\\" and \\\"non-negative\\\", only works when type = number","default":"","version":""},"required":false,"type":"\\\"positive\\\" | \\\"non-negative\\\" "},{"name":"autoSelect","tag":{"cn":"鼠标点击后自动全选数据","en":"Automatically select all data after mouse click","default":"false","version":""},"required":false,"type":"boolean "},{"name":"autoFix","tag":{"cn":"失焦后自动按照 digits 精度限制补足 (type 为 number 时生效)","en":"Automatically fill up according to the precision limit of digits after out of focus","default":"false","version":""},"required":false,"type":"boolean "},{"name":"step","tag":{"cn":"改变数字跨度，可为小数","en":"Change the digital span. It can be decimal.","default":"1","version":""},"required":false,"type":"number "},{"name":"allowNull","tag":{"cn":"清空后值为null","en":"allow value is null","default":"false","version":""},"required":false,"type":"boolean "},{"name":"hideArrow","tag":{"cn":"是否隐藏增减按钮","en":"Whether to hide increase/decrease buttons","default":"false","version":""},"required":false,"type":"boolean "}],"cn":"","en":""}]';
