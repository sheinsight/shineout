...
const api = '[{"title":"Input","properties":[{"name":"value","tag":{"en":"value","cn":"输入值"},"type":"string"},{"name":"onChange","tag":{"en":"onChange","cn":"值改变回调"},"type":"(value?: string ) => void"},{"name":"beforeChange","tag":{"en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","cn":"值改变前的回调，当返回值不为空时将作为组件的新值","override":"(value: any , datum?: FormDatum) => any"},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"en":"rules validation callback","cn":"rules 校验回调"},"type":"(e?: Error ) => void"},{"name":"popover","tag":{"en":"The position where the text pop up","cn":"信息弹出位置","override":"PopoverProps[\\\"position\\\"]"},"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"en":"Disable component","cn":"禁用组件","default":"false"},"type":"boolean"},{"name":"bind","tag":{"en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用"},"type":"string[]"},{"name":"defaultValue","tag":{"en":"default value","cn":"默认值"},"type":"string"},{"name":"reserveAble","tag":{"en":"If set to true, the form will not automatically delete the data after the component is uninstalled","cn":"设置为true 组件卸载后表单不自动删除数据"},"type":"boolean"},{"name":"rules","tag":{"en":"Validation rules, see Rule usage for details","cn":"校验规则 详见 Rule 用法","override":"RuleItem[]"},"type":"RuleItem[]"},{"name":"name","tag":{"en":"Form field, used with Form","cn":"表单字段,配合 Form 使用"},"type":"string"},{"name":"size","tag":{"en":"size","cn":"尺寸","default":"\\\"default\\\"","override":"union"},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"onFocus","tag":{"en":"The callback when Textarea focus","cn":"聚焦后的回调"},"type":"FocusEventHandler<Element>"},{"name":"onBlur","tag":{"en":"The callback of blur","cn":"失去焦点后的回调"},"type":"FocusEventHandler<Element>"},{"name":"tip","tag":{"en":"Prompt information","cn":"提示信息"},"type":"ReactNode"},{"name":"width","tag":{"en":"width","cn":"宽度"},"type":"number"},{"name":"popoverProps","tag":{"en":"Vilidate popup properties, specific properties refer to Popover component description","cn":"校验弹框接受的属性，具体属性参考Popover组件说明","type":""},"type":"PopoverProps"},{"name":"underline","tag":{"en":"show border bottom","cn":"仅仅展示下边框","default":"false"},"type":"boolean"},{"name":"autoFocus","tag":{"en":"Whether to automatically get the focus","cn":"是否自动获得焦点","default":"false"},"type":"boolean"},{"name":"border","tag":{"en":"Whether to display border","cn":"是否展示边框","default":"false"},"type":"boolean"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"placeholder","tag":{"en":"Same as the native input tag","cn":"同原生 input 标签的 placeholder"},"type":"string"},{"name":"type","tag":{"en":"Same as the type of the native input tag","cn":"同原生 input 标签的 type","default":"\\\"text\\\""},"type":"string"},{"name":"clearable","tag":{"en":"Remove content of the input when clicking the clear icon, clear event function","cn":"可点击清空图标删除输入框内容，为函数式表示清空回调","default":"false"},"type":"boolean | (() => void)"},{"name":"innerTitle","tag":{"en":"inner title","cn":"内嵌标题"},"type":"ReactNode"},{"name":"info","tag":{"en":"Infomation","cn":"提示信息"},"type":"number | ((msg: string) => string)"},{"name":"delay","tag":{"en":"User input triggers the onChange and to check interval, unit: ms.","cn":"用户输入触发 onChange 和校验间隔时间，单位 毫秒。","default":": 400"},"type":"number"},{"name":"coin","tag":{"en":"Show as thousands separator, valid only when type is \\\"number\\\"","cn":"以千位分隔符展示,仅当type为number时有效","default":"false"},"type":"boolean"},{"name":"placeTitle","tag":{"en":"Placeholder title, which needs to be used together with innerTitle","cn":"占位标题，需要配合 innerTitle 一起使用"},"type":"ReactNode"},{"name":"onEnterPress","tag":{"en":"The callback function for enter key","cn":"回车键回调函数"},"type":"(value: string, e?: any) => void"},{"name":"onKeyDown","tag":{"en":"The callback function for key down","cn":"键盘按下回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"onKeyUp","tag":{"en":"The callback function for key up","cn":"键盘按下后抬起的回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"maxLength","tag":{"en":"input max length","cn":"可输入最大长度"},"type":"number"},{"name":"forwardedRef","tag":{"en":"get input element","cn":"获取 input dom 元素"},"type":"(el: HTMLElement) => void"},{"name":"clearToUndefined","tag":{"en":"After clicking the clear button, the data becomes undefined","cn":"点击清除按钮后数据变为 undefined","default":"false"},"type":"boolean"},{"name":"digits","tag":{"en":"Decimal place limit (valid when type is number)","cn":"小数位限制(type 为 number 时生效)"},"type":"number"},{"name":"integerLimit","tag":{"en":"Integer bit limit (valid when type is number)","cn":"整数位数限制, 仅在type = number 下生效"},"type":"number"},{"name":"numType","tag":{"en":"Number type supports \\\"positive\\\" and \\\"non-negative\\\", only works when type = number","cn":"设置数字类型 支持 \\\"positive\\\" 和 \\\"non-negative\\\", 仅在type = number 下生效"},"type":"\\\"positive\\\" | \\\"non-negative\\\""},{"name":"autoSelect","tag":{"en":"Automatically select all data after mouse click","cn":"鼠标点击后自动全选数据","default":"false"},"type":"boolean"},{"name":"autoFix","tag":{"en":"Automatically fill up according to the precision limit of digits after out of focus","cn":"失焦后自动按照 digits 精度限制补足 (type 为 number 时生效)","default":"false"},"type":"boolean"},{"name":"htmlName","tag":{"en":"The original property of html","cn":"原生html属性"},"type":"string"},{"name":"trim","tag":{"en":"When trim is true, blank characters are automatically deleted when lose focus。","cn":"trim 为 true 时，失去焦点时会自动删除空白字符。","default":"false"},"type":"boolean"}]},{"title":"Input.Number","properties":[{"name":"value","tag":{"en":"value","cn":"值"},"type":"string | number"},{"name":"onChange","tag":{"en":"onChange","cn":"值改变回调"},"type":"(value?: InputValue | number | null ) => void"},{"name":"beforeChange","tag":{"en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","cn":"值改变前的回调，当返回值不为空时将作为组件的新值","override":"(value: any , datum?: FormDatum) => any"},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"en":"rules validation callback","cn":"rules 校验回调"},"type":"(e?: Error ) => void"},{"name":"popover","tag":{"en":"The position where the text pop up","cn":"信息弹出位置","override":"PopoverProps[\\\"position\\\"]"},"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"en":"Disable component","cn":"禁用组件","default":"false"},"type":"boolean"},{"name":"bind","tag":{"en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用"},"type":"string[]"},{"name":"defaultValue","tag":{"en":"default value","cn":"默认值"},"type":"string | number"},{"name":"reserveAble","tag":{"en":"If set to true, the form will not automatically delete the data after the component is uninstalled","cn":"设置为true 组件卸载后表单不自动删除数据"},"type":"boolean"},{"name":"rules","tag":{"en":"Validation rules, see Rule usage for details","cn":"校验规则 详见 Rule 用法","override":"RuleItem[]"},"type":"RuleItem[]"},{"name":"name","tag":{"en":"Form field, used with Form","cn":"表单字段,配合 Form 使用"},"type":"string"},{"name":"size","tag":{"en":"size","cn":"尺寸","default":"\\\"default\\\"","override":"union"},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"onFocus","tag":{"en":"The callback when Textarea focus","cn":"聚焦后的回调"},"type":"FocusEventHandler<Element>"},{"name":"onBlur","tag":{"en":"The callback of blur","cn":"失去焦点后的回调"},"type":"FocusEventHandler<Element>"},{"name":"tip","tag":{"en":"Prompt information","cn":"提示信息"},"type":"ReactNode"},{"name":"width","tag":{"en":"width","cn":"宽度"},"type":"number"},{"name":"popoverProps","tag":{"en":"Vilidate popup properties, specific properties refer to Popover component description","cn":"校验弹框接受的属性，具体属性参考Popover组件说明","type":""},"type":"PopoverProps"},{"name":"underline","tag":{"en":"show border bottom","cn":"仅仅展示下边框","default":"false"},"type":"boolean"},{"name":"autoFocus","tag":{"en":"Whether to automatically get the focus","cn":"是否自动获得焦点","default":"false"},"type":"boolean"},{"name":"border","tag":{"en":"Whether to display border","cn":"是否展示边框","default":"false"},"type":"boolean"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"placeholder","tag":{"en":"Same as the native input tag","cn":"同原生 input 标签的 placeholder"},"type":"string"},{"name":"min","tag":{"en":"The minimum value","cn":"最小值"},"type":"number"},{"name":"max","tag":{"en":"The maximum value","cn":"最大值"},"type":"number"},{"name":"clearable","tag":{"en":"Remove content of the input when clicking the clear icon, clear event function","cn":"可点击清空图标删除输入框内容，为函数式表示清空回调","default":"false"},"type":"boolean | (() => void)"},{"name":"innerTitle","tag":{"en":"inner title","cn":"内嵌标题"},"type":"ReactNode"},{"name":"info","tag":{"en":"Infomation","cn":"提示信息"},"type":"number | ((msg: string) => string)"},{"name":"onMouseDown","tag":{"en":"The callback function for mouse down","cn":"鼠标按下后的回调"},"type":"(e: MouseEvent<Element, MouseEvent>) => void"},{"name":"onMouseUp","tag":{"en":"The callback function for mouse up","cn":"鼠标按下后抬起的回调"},"type":"(e: MouseEvent<Element, MouseEvent>) => void"},{"name":"coin","tag":{"en":"Show as thousands separator, valid only when type is \\\"number\\\"","cn":"以千位分隔符展示,仅当type为number时有效","default":"false"},"type":"boolean"},{"name":"placeTitle","tag":{"en":"Placeholder title, which needs to be used together with innerTitle","cn":"占位标题，需要配合 innerTitle 一起使用"},"type":"ReactNode"},{"name":"onEnterPress","tag":{"en":"The callback function for enter key","cn":"回车键回调函数"},"type":"(value: string, e?: any) => void"},{"name":"onKeyDown","tag":{"en":"The callback function for key down","cn":"键盘按下回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"onKeyUp","tag":{"en":"The callback function for key up","cn":"键盘按下后抬起的回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"maxLength","tag":{"en":"input max length","cn":"可输入最大长度"},"type":"number"},{"name":"forwardedRef","tag":{"en":"get input element","cn":"获取 input dom 元素"},"type":"(el: HTMLElement) => void"},{"name":"clearToUndefined","tag":{"en":"After clicking the clear button, the data becomes undefined","cn":"点击清除按钮后数据变为 undefined","default":"false"},"type":"boolean"},{"name":"digits","tag":{"en":"Decimal place limit (valid when type is number)","cn":"小数位限制(type 为 number 时生效)"},"type":"number"},{"name":"integerLimit","tag":{"en":"Integer bit limit (valid when type is number)","cn":"整数位数限制, 仅在type = number 下生效"},"type":"number"},{"name":"numType","tag":{"en":"Number type supports \\\"positive\\\" and \\\"non-negative\\\", only works when type = number","cn":"设置数字类型 支持 \\\"positive\\\" 和 \\\"non-negative\\\", 仅在type = number 下生效"},"type":"\\\"positive\\\" | \\\"non-negative\\\""},{"name":"autoSelect","tag":{"en":"Automatically select all data after mouse click","cn":"鼠标点击后自动全选数据","default":"false"},"type":"boolean"},{"name":"autoFix","tag":{"en":"Automatically fill up according to the precision limit of digits after out of focus","cn":"失焦后自动按照 digits 精度限制补足 (type 为 number 时生效)","default":"false"},"type":"boolean"},{"name":"htmlName","tag":{"en":"The original property of html","cn":"原生html属性"},"type":"string"},{"name":"trim","tag":{"en":"When trim is true, blank characters are automatically deleted when lose focus。","cn":"trim 为 true 时，失去焦点时会自动删除空白字符。","default":"false"},"type":"boolean"},{"name":"step","tag":{"en":"Change the digital span. It can be decimal.","cn":"改变数字跨度，可为小数","default":"1"},"type":"number"},{"name":"allowNull","tag":{"en":"allow value is null","cn":"清空后值为null","default":"false"},"type":"boolean"},{"name":"hideArrow","tag":{"en":"Whether to hide increase/decrease buttons","cn":"是否隐藏增减按钮","default":"false"},"type":"boolean"}]},{"title":"Input.Password","properties":[{"name":"value","tag":{"en":"value","cn":"输入值"},"type":"string"},{"name":"onChange","tag":{"en":"onChange","cn":"值改变回调"},"type":"(value?: string ) => void"},{"name":"beforeChange","tag":{"en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","cn":"值改变前的回调，当返回值不为空时将作为组件的新值","override":"(value: any , datum?: FormDatum) => any"},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"en":"rules validation callback","cn":"rules 校验回调"},"type":"(e?: Error ) => void"},{"name":"popover","tag":{"en":"The position where the text pop up","cn":"信息弹出位置","override":"PopoverProps[\\\"position\\\"]"},"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"en":"Disable component","cn":"禁用组件","default":"false"},"type":"boolean"},{"name":"bind","tag":{"en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用"},"type":"string[]"},{"name":"defaultValue","tag":{"en":"default value","cn":"默认值"},"type":"string"},{"name":"reserveAble","tag":{"en":"If set to true, the form will not automatically delete the data after the component is uninstalled","cn":"设置为true 组件卸载后表单不自动删除数据"},"type":"boolean"},{"name":"rules","tag":{"en":"Validation rules, see Rule usage for details","cn":"校验规则 详见 Rule 用法","override":"RuleItem[]"},"type":"RuleItem[]"},{"name":"name","tag":{"en":"Form field, used with Form","cn":"表单字段,配合 Form 使用"},"type":"string"},{"name":"size","tag":{"en":"size","cn":"尺寸","default":"\\\"default\\\"","override":"union"},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"onFocus","tag":{"en":"The callback when Textarea focus","cn":"聚焦后的回调"},"type":"FocusEventHandler<Element>"},{"name":"onBlur","tag":{"en":"The callback of blur","cn":"失去焦点后的回调"},"type":"FocusEventHandler<Element>"},{"name":"tip","tag":{"en":"Prompt information","cn":"提示信息"},"type":"ReactNode"},{"name":"width","tag":{"en":"width","cn":"宽度"},"type":"number"},{"name":"popoverProps","tag":{"en":"Vilidate popup properties, specific properties refer to Popover component description","cn":"校验弹框接受的属性，具体属性参考Popover组件说明","type":""},"type":"PopoverProps"},{"name":"underline","tag":{"en":"show border bottom","cn":"仅仅展示下边框","default":"false"},"type":"boolean"},{"name":"autoFocus","tag":{"en":"Whether to automatically get the focus","cn":"是否自动获得焦点","default":"false"},"type":"boolean"},{"name":"border","tag":{"en":"Whether to display border","cn":"是否展示边框","default":"false"},"type":"boolean"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"placeholder","tag":{"en":"Same as the native input tag","cn":"同原生 input 标签的 placeholder"},"type":"string"},{"name":"type","tag":{"en":"Same as the type of the native input tag","cn":"同原生 input 标签的 type","default":"\\\"text\\\""},"type":"string"},{"name":"clearable","tag":{"en":"Remove content of the input when clicking the clear icon, clear event function","cn":"可点击清空图标删除输入框内容，为函数式表示清空回调","default":"false"},"type":"boolean | (() => void)"},{"name":"innerTitle","tag":{"en":"inner title","cn":"内嵌标题"},"type":"ReactNode"},{"name":"info","tag":{"en":"Infomation","cn":"提示信息"},"type":"number | ((msg: string) => string)"},{"name":"coin","tag":{"en":"Show as thousands separator, valid only when type is \\\"number\\\"","cn":"以千位分隔符展示,仅当type为number时有效","default":"false"},"type":"boolean"},{"name":"placeTitle","tag":{"en":"Placeholder title, which needs to be used together with innerTitle","cn":"占位标题，需要配合 innerTitle 一起使用"},"type":"ReactNode"},{"name":"onEnterPress","tag":{"en":"The callback function for enter key","cn":"回车键回调函数"},"type":"(value: string, e?: any) => void"},{"name":"onKeyDown","tag":{"en":"The callback function for key down","cn":"键盘按下回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"onKeyUp","tag":{"en":"The callback function for key up","cn":"键盘按下后抬起的回调"},"type":"(e: KeyboardEvent<Element>) => void"},{"name":"maxLength","tag":{"en":"input max length","cn":"可输入最大长度"},"type":"number"},{"name":"forwardedRef","tag":{"en":"get input element","cn":"获取 input dom 元素"},"type":"(el: HTMLElement) => void"},{"name":"clearToUndefined","tag":{"en":"After clicking the clear button, the data becomes undefined","cn":"点击清除按钮后数据变为 undefined","default":"false"},"type":"boolean"},{"name":"digits","tag":{"en":"Decimal place limit (valid when type is number)","cn":"小数位限制(type 为 number 时生效)"},"type":"number"},{"name":"integerLimit","tag":{"en":"Integer bit limit (valid when type is number)","cn":"整数位数限制, 仅在type = number 下生效"},"type":"number"},{"name":"numType","tag":{"en":"Number type supports \\\"positive\\\" and \\\"non-negative\\\", only works when type = number","cn":"设置数字类型 支持 \\\"positive\\\" 和 \\\"non-negative\\\", 仅在type = number 下生效"},"type":"\\\"positive\\\" | \\\"non-negative\\\""},{"name":"autoSelect","tag":{"en":"Automatically select all data after mouse click","cn":"鼠标点击后自动全选数据","default":"false"},"type":"boolean"},{"name":"autoFix","tag":{"en":"Automatically fill up according to the precision limit of digits after out of focus","cn":"失焦后自动按照 digits 精度限制补足 (type 为 number 时生效)","default":"false"},"type":"boolean"},{"name":"htmlName","tag":{"en":"The original property of html","cn":"原生html属性"},"type":"string"},{"name":"trim","tag":{"en":"When trim is true, blank characters are automatically deleted when lose focus。","cn":"trim 为 true 时，失去焦点时会自动删除空白字符。","default":"false"},"type":"boolean"},{"name":"point","tag":{"en":"password symbol","cn":"密码符号","default":"\\\".\\\""},"type":"string"}]}]';
