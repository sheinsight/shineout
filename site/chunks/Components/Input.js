...
const examples = [
  {
    name: '01-base',
    title: locate(
      '基本用法 \n Input 通常需要和其他的组件配合使用，所以默认的宽度是 100%，默认 display 为 flex \n 如果设置了 style.width，默认 display 为 inline-flex',
      'Base \n Input usually needs to be used with other components, so the default width is 100% and the default display is flex. \n If the style.width is set, the default display is inline-flex.'
    ),
  ...
  },
  {
    ...
    component: require('doc/pages/components/Input/example-02-allowclear.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-02-allowclear.js'),
  },
  {
    name: '03-size',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-03-size.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-03-size.js'),
  },
  {
    name: '04-number',
    title: locate(
  ...
  },
  {
    ...
    component: require('doc/pages/components/Input/example-05-number.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-05-number.js'),
  },
  {
    name: '06-group',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-06-group.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-06-group.js'),
  },
  {
    name: '07-tip',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-07-tip.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-07-tip.js'),
  },
  {
    name: '08-validate',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-08-validate.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-08-validate.js'),
  },
  {
    name: '09-disabled',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-09-disabled.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-09-disabled.js'),
  },
  {
    name: '10-password',
    title: locate(
    ...
    component: require('doc/pages/components/Input/example-10-password.js').default,
    rawText: require('!raw-loader!doc/pages/components/Input/example-10-password.js'),
  },
]
