...
const examples = [
  ...
  },
  {
    ...
    component: require('doc/pages/components/Tag/example-3-close.js').default,
    rawText: require('!raw-loader!doc/pages/components/Tag/example-3-close.js'),
  },
  {
    name: '4-icon',
    title: locate('内置图标 \n 设置 icon 属性可以显示内置的图标，不同类型的图标见示例', 'Icon \n Set the icon property to display the built-in icon.'),
    component: require('doc/pages/components/Tag/example-4-icon.js').default,
    rawText: require('!raw-loader!doc/pages/components/Tag/example-4-icon.js'),
  },
]
