...
const api = '[{"title":"Breadcrumb","properties":[{"name":"data","tag":{"cn":"面包屑对象数组,见 data","en":"The array of breadcrumb objects, see data","default":"[]","version":""},"type":"any[]"},{"name":"separator","tag":{"cn":"面包屑分隔符,可以是字符串或自定义的元素","en":"A breadcrumb separator which can be strings or custom elements","default":"\\\"/\\\"","version":""},"type":"ReactNode"},{"name":"keygen","tag":{"cn":"生成每一项key的辅助方法。为 true 时，以数据项本身作为key，相当于 (d => d)；为函数时，使用此函数返回值；为string时，使用这个string对应的数据值。如 \\\"id\\\"，相当于 (d => d.id)","en":"Key generator.When it is true, the data itself is used as the key equivalent to (d => d);When it is a function, use its return value;When it is a string，ues the value of the string.For example, \\\"id\\\" is the same thing as (d) => d.id.","default":"","version":""},"type":"undefined | true | ObjectKey<Item> | (data: Item, index?: number ) => string | number"},{"name":"renderItem","tag":{"cn":"自定义渲染","en":"Custom render","default":"","version":""},"type":"((value: Item) => ReactNode) "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""},{"title":"BreadcrumbData","properties":[{"name":"onClick","tag":{"cn":"点击事件","en":"The click event","default":"","version":""},"type":"MouseEventHandler<HTMLAnchorElement> "},{"name":"title","tag":{"cn":"显示内容","en":"Displayed content","default":"","version":""},"type":"ReactNode"},{"name":"url","tag":{"cn":"链接地址，onClick 属性二选一","en":"Link address","default":"","version":""},"type":"string "},{"name":"icon","tag":{"cn":"自定义图标","en":"Custom icon","default":"","version":""},"type":"ReactNode"}],"cn":"","en":""}]';
