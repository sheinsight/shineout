...
const api = '[{"title":"Pagination","properties":[{"name":"align","tag":{"cn":"排布方式","en":"align of pagination","default":"\\\"left\\\"","version":""},"type":"\\\"left\\\" | \\\"right\\\" | \\\"center\\\" "},{"name":"current","tag":{"cn":"当前页，如果传入值，组件为受控组件，必须通过onChange来处理回调","en":"Current page.","default":"","version":""},"type":"number "},{"name":"defaultCurrent","tag":{"cn":"初始页码","en":"Initial page number","default":"1","version":""},"type":"number "},{"name":"disabled","tag":{"cn":"禁用","en":"Disabled","default":"false","version":""},"type":"boolean "},{"name":"layout","tag":{"cn":"子组件布局，可选值为:\\\"links\\\": 页码；\\\"simple\\\": 简约页码(和links不要同时使用)；\\\"list\\\": 每页数量选择。\\\"jumper\\\": 跳转页码；function({ current, total, pageSize }): 匿名函数，用来信息展示","en":"The layout of child elements, options: \\\"links\\\": page number; \\\"simple\\\": simple page number(Do not use both simple and links); \\\"list\\\": page size selector; \\\"jumper\\\": jump to page number; \\\"simple\\\": minimalist mode; function({ current, total, pageSize }): custom information","default":"[\\\"links\\\"]","version":""},"type":"(\\\"links\\\" | \\\"simple\\\" | \\\"list\\\" | \\\"jumper\\\" | ((props: PaginationProps) => string))[] "},{"name":"onChange","tag":{"cn":"页码或每页显示数量改变时回调。current: 新的页码。pageSize: 每页数量","en":"The callback function when current page or pageSize is changing。current: new page number。pageSize: number of each page","default":"","version":""},"type":"((current: number, pageSize: number, sizeChange?: boolean ) => void) "},{"name":"pageSize","tag":{"cn":"每页数量","en":"Number of each page","default":"10","version":""},"type":"number "},{"name":"pageSizeList","tag":{"cn":"[10, 20, 30, 50, 100] | 每页数量可选列表","en":"The list of number of each page","default":"[10, 20, 30, 50, 100]","version":""},"type":"number[] "},{"name":"size","tag":{"cn":"尺寸","en":"size of pagination","default":"\\\"default\\\"","version":""},"type":"\\\"default\\\" | \\\"small\\\" | \\\"large\\\" "},{"name":"text","tag":{"cn":"替换文案。prev: 上一页。next: 下一页。page: pageSizeList文字。jumper: 跳转输入框文字, \\\"{input}\\\" 为输入框占位","en":"Replaced text。prev: the previous page。next: the next page。page:the text of pageSizeList。jumper: jump to input box text, \\\"{input}\\\" pilaceholder for input box","default":"","version":""},"type":"{ prev?: string  next?: string  page?: string  jumper?: string  } "},{"name":"total","tag":{"cn":"总条目数。如果 total 小于 0，隐藏分页。","en":"Total number. If total is less than 0, hide the Pagination.","default":"0","version":""},"type":"number "},{"name":"sizeListProps","tag":{"cn":"需要给分页数量的选择框的额外的属性","en":"Additional attributes which need to given page size selector","default":"","version":""},"type":"SelectProps<number, number> "},{"name":"span","tag":{"cn":"分页器页码按钮数量","en":"The number of pagination buttons","default":"5","version":""},"type":"number "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""}]';
