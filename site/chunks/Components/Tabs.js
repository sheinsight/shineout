...
const api = '[{"title":"Tab","properties":[{"name":"active","tag":{"cn":"当前选中标签页（受控）","en":"Current active tab id or index","default":"0","version":""},"type":"Key "},{"name":"align","tag":{"cn":"设置标签对齐方式","en":"set the label align","default":"","version":""},"type":"\\\"left\\\" | \\\"right\\\" | \\\"vertical-left\\\" | \\\"vertical-right\\\" | \\\"bottom\\\" "},{"name":"background","tag":{"cn":"选中标签背景色","en":"Active background color","default":"","version":""},"type":"string "},{"name":"border","tag":{"cn":"边框颜色","en":"Border color","default":"","version":""},"type":"string "},{"name":"children","tag":{"cn":"必须为 Panel 元素","en":"must be Panel","default":"","version":""},"type":"any"},{"name":"collapsible","tag":{"cn":"是否可折叠","en":"Whether can be collapsed","default":"","version":""},"type":"boolean "},{"name":"color","tag":{"cn":"标签页文字颜色，仅当 shape 为 \\\"card\\\" 时生效","en":"the color of tab\\\"s text only when the shape is \\\"card\\\"","default":"","version":""},"type":"string "},{"name":"defaultActive","tag":{"cn":"默认选中标签页（非受控）","en":"Default active tab id or index","default":"","version":""},"type":"Key "},{"name":"defaultCollapsed","tag":{"cn":"默认折叠状态,当 collapsible 设置为 true 时生效","en":"default collapse state, effective when collapsible is set to true","default":"","version":""},"type":"boolean "},{"name":"inactiveBackground","tag":{"cn":"未选中标签背景色","en":"Inactive background color","default":"","version":""},"type":"string "},{"name":"shape","tag":{"cn":"shape 不为空时，background 等颜色参数将会无效","en":"If shape is not null, the style properties such as background, border will lose effect","default":"\\\"card\\\"","version":""},"type":"\\\"card\\\" | \\\"line\\\" | \\\"button\\\" | \\\"bordered\\\" | \\\"dash\\\" "},{"name":"tabBarExtraContent","tag":{"cn":"tab bar 上额外的元素","en":"extra element in tab bar","default":"","version":""},"type":"ReactNode"},{"name":"tabBarStyle","tag":{"cn":"tab bar 的样式对象","en":"style in tab bar","default":"","version":""},"type":"CSSProperties "},{"name":"lazy","tag":{"cn":"是否开启懒加载","en":"lazy load","default":"true","version":""},"type":"boolean "},{"name":"autoFill","tag":{"cn":"自动填充内容区域","en":"auto fill the panel","default":"false","version":""},"type":"boolean "},{"name":"sticky","tag":{"cn":"开启头部附着","en":"sticky header","default":"false","version":""},"type":"number | boolean | StickyProps "},{"name":"switchToTop","tag":{"cn":"切换tab将自动滚动到Tabs","en":"switch tabs will scroll to Tabs","default":"","version":""},"type":"boolean "},{"name":"hideSplit","tag":{"cn":"是否隐藏分割线","en":"whether to hide the dividing line","default":"","version":""},"type":"boolean "},{"name":"onChange","tag":{"cn":"标签选中时触发回调事件","en":"Change callback","default":"","version":""},"type":"((key: Key) => void) "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""},{"title":"Panel","properties":[{"name":"id","tag":{"cn":"选填，默认为 index","en":"The default is index","default":"","version":""},"type":"string | number "},{"name":"background","tag":{"cn":"背景色，会覆盖 Tabs 的background","en":"Background color, override the Tab\\\"s background","default":"","version":""},"type":"string "},{"name":"color","tag":{"cn":"同 style.color","en":"same as style.color","default":"","version":""},"type":"string "},{"name":"children","tag":{"cn":"Panel 内容","en":"Panel Content","default":"","version":""},"type":"ReactNode"},{"name":"tab","tag":{"cn":"懒加载","en":"lazy load","default":"","version":""},"type":"ReactNode"},{"name":"border","tag":{"cn":"边框颜色，会覆盖 Tabs 的border","en":"Border color, override the Tab\\\"s border","default":"","version":""},"type":"string "},{"name":"disabled","tag":{"cn":"是否禁用","en":"Specifies the Panel should be disabled","default":"false","version":""},"type":"boolean "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""}]';
