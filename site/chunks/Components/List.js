...
const api = '[{"title":"List","properties":[{"name":"size","tag":{"cn":"尺寸","en":"size","default":"","version":""},"type":"\\\"default\\\" | \\\"small\\\" | \\\"large\\\""},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"disabled","tag":{"cn":"如果 disabled 为 true，禁用全部选项，如果 disabled 为函数，根据函数反回结果禁用选项","en":"When the value is true, disabled all checkboxes; When the value is function, disable the checkbox that this function returns true.","default":"false","version":""},"type":"((data: Item) => boolean) | boolean"},{"name":"value","tag":{"cn":"当前选中值，格式和 onChange 返回值一致","en":"The current selected value.","default":"","version":""},"type":"any[]"},{"name":"onChange","tag":{"cn":"选择行。rowData为选中的数据，rowIndex为选中行号。如果需要数据需要格式化的处理，建议配置 format。","en":"Select the row ,rowData is the selected data, rowIndex is the selected row number. If the data needs to be formatted, it is recommended to configure format","default":"","version":""},"type":"((rowData: Value, index: number) => void) "},{"name":"loading","tag":{"cn":"加载中","en":"loading","default":"false","version":""},"type":"ReactNode"},{"name":"prediction","tag":{"cn":"(val, d) => val===format(d) | 默认使用 format 函数执行的结果来比较是否匹配，在某些情况下（例如返回原始数据的对象，更新数据时，生成了一个值相同，非同一个对象的选项），需要借助 prediction 函数来判断是否匹配","en":"By default, the result of the format function is used to compare whether it matches. In some cases (for example, whe an object that returns the original data is updated, an different option with the same value  is generated), the prediction function needs to be used to determine whether match","default":"(val, d) => val===format(d)","version":""},"type":"((value: Value extends (infer U)[] ? U : Value, data: DataItem) => boolean) "},{"name":"format","tag":{"cn":"格式化 value。 默认值，返回原始数据。 为string时，会作为key从原始数据中获取值，相当于 (d) => d[format]。为函数时，以函数返回结果作为 value。","en":"Format value. The defaule value is return the original data. When it is a string, the value is fetched from the original data as a key equivalent to (d) => d[format] When it is a function, use its return value.","default":"d => d","version":""},"type":"ObjectKey<Item> | ((data: Item) => Value extends (infer U)[] ? U : Value)"},{"name":"renderItem","tag":{"cn":"需要渲染成列表的数据","en":"render item","default":"","version":""},"type":"ObjectKey<DataItem> | ((d: DataItem, index: number) => ReactNode) "},{"name":"keygen","tag":{"cn":"生成每一项key的辅助方法\\n为 true 时，以数据项本身作为key，相当于 (d => d)\\n为函数时，使用此函数返回值\\n为string时，使用这个string对应的数据值。如 \\\"id\\\"，相当于 (d => d.id)","en":"Generate a auxiliary method for each key\\nIf not filled, index will be used (not recommended, in some cases there may be problems)\\nWhen it is a function, use its return value.\\nWhen it is a string，ues the value of the string.For example, \\\"id\\\" is the same thing as (d) => d.id .","default":"","version":""},"type":"ObjectKey<DataItem> | ((data: DataItem, index?: number) => KeygenResult) | true"},{"name":"data","tag":{"cn":"渲染数据","en":"render data","default":"","version":""},"type":"DataItem[]"},{"name":"bordered","tag":{"cn":"是否显示边框","en":"show border","default":"false","version":""},"type":"boolean "},{"name":"empty","tag":{"cn":"无数据时展示的内容","en":"What to display when no data","default":"","version":""},"type":"ReactNode"},{"name":"colNum","tag":{"cn":"多列展示","en":"Multi-column display","default":"1","version":""},"type":"number "},{"name":"fixed","tag":{"cn":"是否启用虚拟列表","en":"virtualized list","default":"false","version":""},"type":"boolean "},{"name":"height","tag":{"cn":"列表高度","en":"list height","default":"","version":""},"type":"number "},{"name":"lineHeight","tag":{"cn":"列表项高度","en":"height of item","default":"32","version":""},"type":"number "},{"name":"rowsInView","tag":{"cn":"同时展示的列表项数量","en":"Number of list items displayed at the same time","default":"10","version":""},"type":"number "},{"name":"scrollLoading","tag":{"cn":"滚动到底部时触发","en":"Triggered when scrolling to the bottom","default":"","version":""},"type":"(() => void) "},{"name":"footer","tag":{"cn":"底部内容","en":"The content at the bottom","default":"","version":""},"type":"ReactNode | (() => ReactNode)"},{"name":"rowClassName","tag":{"cn":"自定义行 className","en":"custom row className","default":"","version":""},"type":"((rowData: DataItem, index: number) => string) "},{"name":"pagination","tag":{"cn":"展示分页 详见 Pagination","en":"Show pagination See Pagination for details","default":"","version":""},"type":"PaginationProps "}],"cn":"","en":""},{"title":"List.BaseItem","properties":[{"name":"desc","tag":{"cn":"描述","en":"describe","default":"","version":""},"type":"string "},{"name":"title","tag":{"cn":"列表元素的标题","en":"The title of the list","default":"","version":""},"type":"string "},{"name":"className","tag":{"cn":"Item 容器的className","en":"Item className","default":"","version":""},"type":"string "},{"name":"extra","tag":{"cn":"列表右侧内容","en":"Content area on the right side of the list","default":"","version":""},"type":"ReactNode | ReactNode[]"},{"name":"avatar","tag":{"cn":"列表元素的图标","en":"List images","default":"","version":""},"type":"ReactNode | (() => ReactNode)"},{"name":"content","tag":{"cn":"列表内容","en":"list content","default":"","version":""},"type":"ReactNode | (() => ReactNode)"}],"cn":"","en":""}]';
