...
const api = '[{"title":"DatePicker","properties":[{"name":"value","tag":{"cn":"值为 string 时，需要和 format 属性匹配。\\n 非 string 会格式化为 string。\\n range 属性为 true 时，值为长度为2的数组","en":"When the value is string, it needs to match the format attribute.\\n When the range property is true, the value is an array of length 2.","default":""},"type":"string | number | Date | (Date | number | string )[]"},{"name":"onChange","tag":{"cn":"值改变回调函数","en":"a callback when the value is changing","default":""},"type":"(value: Value, quickSelect?: { name: string value: Value } | null ) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":""},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":""},"type":"(e?: Error ) => void"},{"name":"popover","tag":{"cn":"信息弹出位置","en":"The position where the text pop up","default":""},"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"cn":"如果 disabled 为 true，禁用全部选项，如果 disabled 为函数，根据函数反回结果禁用选项","en":"When the value is true, disabled all options; When the value is function, disable the options that this function returns true.","default":"false"},"type":"boolean | ((date: Date, type?: \\\"start\\\" | \\\"end\\\" , value0?: Date , value1?: Date ) => boolean)"},{"name":"filterSameChange","tag":{"cn":"当两次选择的值相同时不触发onChange","en":"onChange is not triggered when two selected values are the same","default":"false"},"type":"boolean"},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":""},"type":"string[]"},{"name":"defaultValue","tag":{"cn":"默认值","en":"defaultValue","default":""},"type":"any"},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":""},"type":"boolean"},{"name":"rules","tag":{"cn":"校验规则 详见 Rule 用法","en":"Validation rules, see Rule usage for details","default":""},"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段,配合 Form 使用","en":"Form field, used with Form","default":""},"type":"string | string[]"},{"name":"size","tag":{"cn":"不同尺寸","en":"There are three built-in size: small、default、large.","default":""},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"clearable","tag":{"cn":"If clearable is true, show clear value icon","en":"是否显示清除数据图标","default":"true"},"type":"boolean"},{"name":"placeholder","tag":{"cn":"占位文字。range 属性不为空时，为长度为2的数组","en":"placeholder text. When the range property is not empty, it is an array of length 2.","default":""},"type":"string | string[]"},{"name":"width","tag":{"cn":"输入框宽度","en":"input width","default":""},"type":"string | number"},{"name":"innerTitle","tag":{"cn":"内嵌标题","en":"inner title","default":""},"type":"ReactNode"},{"name":"onBlur","tag":{"cn":"blur 事件回调","en":"blur event callback","default":""},"type":"(e: any) => void"},{"name":"onFocus","tag":{"cn":"focus 事件回调","en":"focus event callback","default":""},"type":"(e: any) => void"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"min","tag":{"cn":"可选最小值","en":"option min value","default":""},"type":"string | number | Date"},{"name":"max","tag":{"cn":"可选最大值","en":"option max value","default":""},"type":"string | number | Date"},{"name":"range","tag":{"cn":"范围跨度，单位 **秒**，为 true 时表示不限制选择范围。","en":"range span，unit: **second**，When it is true, selection scope is not limited.","default":""},"type":"number | boolean"},{"name":"align","tag":{"cn":"值水平排布方式","en":"horizontal align of the value","default":"center"},"type":"\\\"left\\\" | \\\"center\\\" | \\\"right\\\""},{"name":"children","tag":{"cn":"额外渲染的节点","en":"extra children","default":""},"type":"ReactNode"},{"name":"inputable","tag":{"cn":"可输入","en":"Allow enter something into DatePicker","default":""},"type":"boolean"},{"name":"format","tag":{"cn":"不同type对应的默认值。\\\"date\\\": \\\"YYYY-MM-DD\\\"。\\\"time\\\": \\\"HH:mm:ss\\\"。\\\"week\\\": \\\"GGGG WW\\\"。\\\"month\\\": \\\"YYYY-MM\\\"。\\\"quarter\\\": \\\"YYYY-[Q]Q\\\"。 \\\"year\\\": \\\"YYYY\\\" 。 \\\"datetime\\\": \\\"YYYY-MM-DD HH:mm:ss\\\"","en":"default values for different types: \\\"date\\\": \\\"YYYY-MM-DD\\\". \\\"time\\\": \\\"HH:mm:ss\\\". \\\"week\\\": \\\"GGGG WW\\\". \\\"month\\\": \\\"YYYY-MM\\\". \\\"week\\\": \\\"GGGG WW\\\". \\\"quarter\\\": \\\"YYYY-[Q]Q\\\". \\\"year\\\": \\\"YYYY\\\". \\\"datetime\\\": \\\"YYYY-MM-DD HH:mm:ss\\\"","default":""},"type":"string"},{"name":"tip","tag":{"cn":"提示信息","en":"Prompt information","default":""},"type":"ReactNode"},{"name":"popoverProps","tag":{"cn":"校验弹框接受的属性，具体属性参考Popover组件说明","en":"Vilidate popup properties, specific properties refer to Popover component description","default":""},"type":"PopoverProps"},{"name":"underline","tag":{"cn":"是否只展示下边框","en":"only display border bottom","default":"false"},"type":"boolean"},{"name":"border","tag":{"cn":"是否展示边框","en":"Whether to display border","default":"false"},"type":"boolean"},{"name":"formatResult","tag":{"cn":"对选中时间进行格式化","en":"Format the selected time","default":"props.format"},"type":"string | ((date: Date) => string)"},{"name":"position","tag":{"cn":"弹出框位置","en":"Set Position can control the different position of DatePicker","default":""},"type":"\\\"left-top\\\" | \\\"left-bottom\\\" | \\\"right-top\\\" | \\\"right-bottom\\\""},{"name":"type","tag":{"cn":"时间类型","en":"type of datepicker","default":"\\\"date\\\""},"type":"\\\"date\\\" | \\\"time\\\" | \\\"datetime\\\" | \\\"month\\\" | \\\"week\\\" | \\\"quarter\\\" | \\\"year\\\""},{"name":"allowSingle","tag":{"cn":"是否允许单选, 仅在 range 模式下有效","en":"allow single select, only in range can set","default":"false"},"type":"boolean"},{"name":"defaultTime","tag":{"cn":"选择日期时默认的时间, 格式为: \\\"HH:mm:ss\\\"","en":"Default time when selecting a date, the format is: \\\"HH:mm:ss\\\"","default":""},"type":"string | number | Date | (Date | number | string )[]"},{"name":"absolute","tag":{"cn":"为 true 时，选项弹出层在 DOM 中独立 render; 为函数时，返回值作为弹出层容器","en":"When it is true, the pop-up layer of option append into document.body; When it is a function, the return value is used as the popup layer container","default":"false"},"type":"boolean | (() => HTMLElement)"},{"name":"zIndex","tag":{"cn":"选项列表 z-index 值, 需要配合 absolute","en":"options z-index should use with absolute","default":"1000"},"type":"number"},{"name":"quickSelect","tag":{"cn":"快速选择, 仅在 range 模式下有效, name: 文字提示, value: 时间范围","en":"quick select, only in range can set, name: tip, value: range date","default":"false"},"type":"{name: string, value: Value}[]"},{"name":"defaultRangeMonth","tag":{"cn":"范围选择的初始月份, 值为时间对象 或者时间戳, 仅在 range 模式下生效, 优先级低于 value 和 defaultValue","en":"The initial month of range selection, the value is a time object, valid only in range mode, and the priority is lower than value and defaultValue","default":""},"type":"(Date | number | string )[]"},{"name":"defaultPickerValue","tag":{"cn":"面板默认时间，在未选择日期时生效","en":"default date of panel，work under has no value","default":""},"type":"string | number | Date | (Date | number | string )[]"},{"name":"hourStep","tag":{"cn":"小时选项步长","en":"hour step","default":""},"type":"number"},{"name":"minuteStep","tag":{"cn":"分钟选项步长","en":"minute step","default":""},"type":"number"},{"name":"secondStep","tag":{"cn":"秒选项步长","en":"second step","default":""},"type":"number"},{"name":"onPickerChange","tag":{"cn":"值改变回调，有别于 onChange, onPickerChange会在每项值改变的时候执行","en":"value onchange callback (every type of date)","default":""},"type":"(value: DateTimeType | DateTimeType[], quickSelect: void | { name: string value: Value } , areaType: \\\"year\\\" | \\\"month\\\" | \\\"week\\\" | \\\"day\\\" | \\\"time\\\" | \\\"quick\\\" | \\\"quarter\\\") => void"},{"name":"disabledTime","tag":{"cn":"禁用指定 Time。","en":"Disable the specified Time.","default":""},"type":"string | ((time: string) => boolean)"},{"name":"clearWithUndefined","tag":{"cn":"onChange get undefined while clear","en":"清空值时抛出 undefined","default":"false"},"type":"boolean"},{"name":"timeZone","tag":{"cn":"设置默认时区,格式为/^([+-]\\\\d{2})$/ 支持 \\\"-12\\\" 到 \\\"+13\\\"","en":"Set the default time zone, the format is /^([+-]\\\\d{2})$/ Support \\\"-12\\\" to \\\"+13\\\"","default":""},"type":"string"}],"cn":"","en":""}]';
