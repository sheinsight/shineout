...
const api = '[{"title":"Tree","properties":[{"name":"active","tag":{"cn":"激活节点的key","en":"active node key","default":"","version":""},"type":"string | number "},{"name":"data","tag":{"cn":"数据，子节点为children，如果 children 值为 null 或 长度为 0 时，视为叶子节点","en":"active nodes","default":"[]","version":""},"type":"DataItem[]"},{"name":"defaultExpanded","tag":{"cn":"默认展开的节点 key（非受控）","en":"default expanded nodes","default":"","version":""},"type":"(string | number)[] "},{"name":"defaultValue","tag":{"cn":"默认选中的 key （非受控）","en":"Default selected key (not controlled)","default":"","version":""},"type":"Value "},{"name":"disabled","tag":{"cn":"显示选择框时有效，为 true 时，所有节点禁用选择，为函数时，根据函数返回结果确定是否禁用","en":"control whether the node can be chosen","default":"","version":""},"type":"boolean | ((data: DataItem) => boolean) "},{"name":"expanded","tag":{"cn":"展开的节点 key （受控）","en":"expanded node","default":"","version":""},"type":"(string | number)[] "},{"name":"line","tag":{"cn":"是否显示连接线","en":"whether show line","default":"true","version":""},"type":"boolean "},{"name":"loader","tag":{"cn":"设置loader属性后，未定义children的节点视为动态加载节点，点击展开触发 loader事件，children 为 null 或者长度为 0 视为叶子节点","en":"dynamically load nodes","default":"","version":""},"type":"((key: Value extends (infer U)[] ? U : Value, data: DataItem) => void) "},{"name":"mode","tag":{"cn":"选中值模式","en":"selected mode","default":"1","version":""},"type":"0 | 1 | 2 | 3 | 4 "},{"name":"onChange","tag":{"cn":"设置 onChange 属性时，显示 选择框。参数为当前选中值，和 mode 属性相关","en":"change event","default":"","version":""},"type":"((value: Value, id: string | number) => void) "},{"name":"onClick","tag":{"cn":"节点点击事件","en":"click event","default":"","version":""},"type":"((data: DataItem, key: string | number, path: {  children: (string | number)[], path: (string | number)[], isDisabled: boolean, indexPath: number[], index: number }) => void) "},{"name":"onExpand","tag":{"cn":"节点展开回调，参数为当前展开节点 key 数组","en":"expand event","default":"","version":""},"type":"((value: (string | number)[]) => void) "},{"name":"onDrop","tag":{"cn":"设置 onDrop 属性时，为可拖动状态","en":"drop event","default":"","version":""},"type":"((data: DataItem[], key: string | number, targetKey: string | number, position: number) => void) "},{"name":"value","tag":{"cn":"选中的 key （受控）","en":"Selected key (controlled)","default":"","version":""},"type":"(string | number)[]"},{"name":"parentClickExpand","tag":{"cn":"点击父节点展开","en":"Expand by click parent node","default":"","version":""},"type":"boolean "},{"name":"defaultExpandAll","tag":{"cn":"默认展开所有节点","en":"expanded all nodes","default":"false","version":""},"type":"boolean "},{"name":"dataUpdate","tag":{"cn":"是否监听 data 变化更新数据","en":"Whether to monitor data changes to update data","default":"true","version":""},"type":"boolean "},{"name":"childrenKey","tag":{"cn":"指定子数据的属性名","en":"specify the name of the subdata","default":"children","version":""},"type":"ObjectKey<DataItem> "},{"name":"expandIcons","tag":{"cn":"自定义展开/收起按钮","en":"DIY icon when expanded","default":"","version":""},"type":"[ExpandIconType<DataItem>, ExpandIconType<DataItem>] "},{"name":"dragImageStyle","tag":{"cn":"拖拽图片的原生style样式","en":"dom style when drop images","default":"","version":""},"type":"object "},{"name":"doubleClickExpand","tag":{"cn":"双击是否展开节点","en":"if need to double-click to expand","default":"false","version":""},"type":"boolean "},{"name":"dragSibling","tag":{"cn":"是否只能平级拖拽","en":"whether it can only be dragged at the same level","default":"","version":""},"type":"boolean "},{"name":"keygen","tag":{"cn":"生成key的辅助方法, 为函数时，使用此函数返回值, 为string时，使用这个string对应的数据值。如 \\\"id\\\"，相当于 (d) => d.id","en":"Auxiliary method for generating key. When it is a function, use the return value of this function. When it is a string, use the data value corresponding to this string. For example, \\\"id\\\" is the same thing as (d) => d.id.","default":"index","version":""},"type":"ObjectKey<DataItem> | ((data: DataItem, parentKey: string | number) => string | number)"},{"name":"dragImageSelector","tag":{"cn":"定义拖拽图片的选择器","en":"selector when dray image","default":"","version":""},"type":"string | ((data: DataItem) => string) "},{"name":"childrenClass","tag":{"cn":"子节点 class, 函数的参数为该条叶子节点数据","en":"the class of children, the params of function is data","default":"","version":""},"type":"string | ((data: DataItem) => string) "},{"name":"leafClass","tag":{"cn":"叶子节点的 class, 函数的参数为该条叶子节点数据","en":"the class of lead, the params of function is data","default":"","version":""},"type":"string | ((data: DataItem) => string) "},{"name":"bindDatum","tag":{"cn":"获取 datum","en":"get datum","default":"","version":""},"type":"((datum: any) => void) "},{"name":"renderItem","tag":{"cn":"为 string 时，返回 d[string]。 为 function 时，返回函数结果","en":"When it is a string, return d[string]. When it is a function, return the result of the function.","default":"","version":""},"type":"ObjectKey<DataItem> | ((data: DataItem, expanded: boolean, active: boolean, id: string | number) => ReactNode)"},{"name":"dragHoverExpand","tag":{"cn":"拖拽时自动展开含有子节点的节点","en":"automatically expand nodes with child nodes when dragging","default":"false","version":""},"type":"boolean "},{"name":"iconClass","tag":{"cn":"展开/收起按钮的类名","en":"class name of icon","default":"","version":""},"type":"string "},{"name":"nodeClass","tag":{"cn":"节点的class，如果是函数，参数为该节点数据","en":"class name of node","default":"","version":""},"type":"string | ((data: DataItem) => string) "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""}]';
