...
const api = '[{"title":"PopoverProps","properties":[{"name":"background","tag":{"cn":"弹出层背景色（含箭头）","en":"Pop-up background-color(with arrows)","default":"\\\"#fff\\\"","version":""},"type":"string "},{"name":"border","tag":{"cn":"弹出层边框颜色（含箭头）","en":"The color of pop-up border(with arrows)","default":"\\\"#dee2e6\\\"","version":""},"type":"string "},{"name":"children","tag":{"cn":"弹出显示内容，如果内容为函数，则参数是主动关闭操作","en":"Pop-up content.","default":"","version":""},"type":"ReactNode | ((close: (e?: MouseEvent ) => void) => ReactNode)"},{"name":"onClose","tag":{"cn":"Popover 关闭时回调事件","en":"Callback event when close.","default":"","version":""},"type":"(() => void) "},{"name":"onOpen","tag":{"cn":"Popover 弹出回调事件","en":"Callback event when open.","default":"","version":""},"type":"(() => void) "},{"name":"position","tag":{"cn":"弹出层位置","en":"The position of pop-up layer","default":"\\\"top\\\"","version":""},"type":"| \\\"top-left\\\"  | \\\"top\\\"  | \\\"top-right\\\"  | \\\"left-top\\\"  | \\\"left\\\"  | \\\"left-bottom\\\"  | \\\"right-top\\\"  | \\\"right\\\"  | \\\"right-bottom\\\"  | \\\"bottom-left\\\"  | \\\"bottom\\\"  | \\\"bottom-right\\\"  | \\\"cover\\\" "},{"name":"trigger","tag":{"cn":"触发方式","en":"type of show","default":"\\\"hover\\\"","version":""},"type":"\\\"click\\\" | \\\"hover\\\" "},{"name":"type","tag":{"cn":"类型","en":"type of popover","default":"","version":""},"type":"\\\"success\\\" | \\\"info\\\" | \\\"warning\\\" | \\\"danger\\\" "},{"name":"visible","tag":{"cn":"是否显示(受控)","en":"is visible (controlled)","default":"","version":""},"type":"boolean "},{"name":"onVisibleChange","tag":{"cn":"显示隐藏改变时事件","en":"the event of visible change","default":"","version":""},"type":"((visible: boolean) => void) "},{"name":"defaultVisible","tag":{"cn":"默认是否显示","en":"default visible","default":"","version":""},"type":"boolean "},{"name":"mouseEnterDelay","tag":{"cn":"移入显示延迟(毫秒)","en":"the show delay of mouseenter(ms)","default":"0","version":""},"type":"number "},{"name":"mouseLeaveDelay","tag":{"cn":"移除隐藏延迟(毫秒)","en":"the hidden delay of mouseleave (ms)","default":"0","version":""},"type":"number "},{"name":"priorityDirection","tag":{"cn":"弹出位置优先级, 默认为左右优先, 只在未设置 position 时生效, 可选值[\\\"vertical\\\", \\\"horizontal\\\", \\\"auto\\\"]","en":"Popup location priority, default is left and right priority, only valid when position is not set, Options: [\\\"vertical\\\", \\\"horizontal\\\"]","default":"\\\"vertical\\\"","version":""},"type":"\\\"vertical\\\" | \\\"horizontal\\\" | \\\"auto\\\" "},{"name":"getPopupContainer","tag":{"cn":"自定义Popover容器，覆盖默认渲染在body下的行为, () => DOMElement","en":"Custom Popover container, override the default behavior which is rendering under the body, () => DOMElement","default":"","version":""},"type":"(() => HTMLElement) "},{"name":"scrollDismiss","tag":{"cn":"滚动来关闭气泡框，如果需要指定滚动元素，则通过函数返回","en":"scroll to dismiss, return el to order scroller","default":"false","version":""},"type":"boolean | (() => HTMLElement) "},{"name":"showArrow","tag":{"cn":"是否显示箭头","en":"show arrow","default":"true","version":""},"type":"boolean "},{"name":"zIndex","tag":{"cn":"Popover 层级","en":"z-index of popover","default":"1060","version":""},"type":"number "},{"name":"clickToCancelDelay","tag":{"cn":"mouseEnterDelay 内点击元素后取消弹出","en":"Cancel the popup after clicking the element in mouseEnterDelay","default":"false","version":""},"type":"boolean "},{"name":"useTextStyle","tag":{"cn":"使用内置文本样式","en":"using inner styles","default":"","version":""},"type":"boolean "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""},{"title":"Popover.Confirm","properties":[{"name":"text","tag":{"cn":"按钮文字","en":"button text","default":"{ ok: \\\"Ok\\\", cancel: \\\"Cancel\\\" }","version":""},"type":"{ ok?: string ; cancel?: string ; } "},{"name":"onOk","tag":{"cn":"点击确定按钮时触发事件，返回 Promise 时，会在 Promise resolve 后关闭 Tooltip","en":"ok button click callback, will close tooltip while returned promise resolve","default":"","version":""},"type":"(() => void | Promise<any>) "},{"name":"onCancel","tag":{"cn":"点击取消按钮时触发事件，返回 Promise 时，会在 Promise resolve 后关闭 Tooltip","en":"cancel button click callback, will close tooltip while returned promise resolve","default":"","version":""},"type":"(() => void | Promise<any>) "},{"name":"okType","tag":{"cn":"确认按钮的类型，与按钮类型相同","en":"ok button\\\"s type, same with button type","default":"danger","version":""},"type":"\\\"default\\\" | \\\"primary\\\" | \\\"secondary\\\" | \\\"success\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"link\\\" "},{"name":"icon","tag":{"cn":"确认按钮的类型，与按钮类型相同","en":"ok button\\\"s type, same with button type","default":"danger","version":""},"type":"boolean | ReactElement<any, string | JSXElementConstructor<any>> "},{"name":"children","tag":{"cn":"弹出显示内容","en":"Pop-up content.","default":"","version":""},"type":"ReactNode"},{"name":"type","tag":{"cn":"类型同 Alert type 属性","en":"same with Alert type","default":"confirmwarning","version":""},"type":"\\\"success\\\" | \\\"info\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"error\\\" | \\\"confirmwarning\\\" "}],"cn":"属性和 Popover 基本一致，除了以下:","en":"Properties are basically the same as popovers, except for the following:"}]';
