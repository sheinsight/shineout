...
const api = '[{"title":"Button","properties":[{"name":"children","tag":{"cn":"按钮里面的内容, 可以是文字图标等","en":"The content inside the button, can be a text icon, etc.","default":"","version":""},"type":"ReactNode"},{"name":"disabled","tag":{"cn":"禁用","en":"Specifies the button should be disabled","default":"false","version":""},"type":"boolean "},{"name":"href","tag":{"cn":"如果设置了 href 属性，将会用 <a> 代替 <button>","en":"If the href attribute is set, &lt;a> will be used instead of &lt;button>.","default":"","version":""},"type":"string "},{"name":"target","tag":{"cn":"当设置了 href 属性时，target 会被设置到 <a> 元素上","en":"If present, target will be set onto <a> element.(Effective only when href is been set)","default":"","version":""},"type":"string "},{"name":"outline","tag":{"cn":"outline 为 true 时，显示透明背景的按钮","en":"When outline is true, the background is transparent.","default":"false","version":""},"type":"boolean "},{"name":"size","tag":{"cn":"按钮尺寸","en":"size of button","default":"\\\"default\\\"","version":""},"type":"undefined | \\\"default\\\" | \\\"small\\\" | \\\"large\\\""},{"name":"type","tag":{"cn":"按钮类型","en":"type of button","default":"\\\"default\\\"","version":""},"type":"undefined | \\\"success\\\" | \\\"warning\\\" | \\\"default\\\" | \\\"danger\\\" | \\\"primary\\\" | \\\"secondary\\\" | \\\"link\\\""},{"name":"htmlType","tag":{"cn":"按钮原生type属性","en":"type of button original","default":"\\\"button\\\"","version":""},"type":"\\\"button\\\" | \\\"reset\\\" | \\\"submit\\\" "},{"name":"text","tag":{"cn":"文字按钮，不展示边框和背景","en":"text button","default":"false","version":""},"type":"boolean "},{"name":"onClick","tag":{"cn":"按钮点击回调","en":"button click callback","default":"","version":""},"type":"MouseEventHandler<HTMLElement> "},{"name":"space","tag":{"cn":"仅有2个汉字的按钮，是否在2个汉字中间插入空格","en":"For Button with only 2 Chinese characters, whether to insert a space between the two Chinese characters.","default":"false","version":""},"type":"boolean "},{"name":"loading","tag":{"cn":"loading状态","en":"loading","default":"","version":""},"type":"boolean "},{"name":"shape","tag":{"cn":"设置按钮形状","en":"Can be set button shape","default":"\\\"default\\\"","version":""},"type":"undefined | \\\"default\\\" | \\\"circle\\\" | \\\"round\\\""},{"name":"onRef","tag":{"cn":"获取按钮节点","en":"get button dom","default":"","version":""},"type":"((instance: any) => void) "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""},{"title":"ButtonGroup","properties":[{"name":"children","tag":{"cn":"由 Button 组成的 array","en":"array of Button","default":"","version":""},"type":"ReactNode"},{"name":"size","tag":{"cn":"同 Button；如果 Button 和 Group 同时设置 size，以 Group 为准","en":"same as Button","default":"","version":""},"type":"undefined | \\\"default\\\" | \\\"small\\\" | \\\"large\\\""},{"name":"outline","tag":{"cn":"同 Button；如果 Button 未设置，使用此值","en":"same as Button","default":"","version":""},"type":"boolean "},{"name":"type","tag":{"cn":"同 Button；如果 Button 和 Group 同时设置 type，以 Group 为准","en":"same as Button","default":"","version":""},"type":"\\\"default\\\" | \\\"primary\\\" | \\\"secondary\\\" | \\\"success\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"link\\\" "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""}]';
