...
const api = '[{"title":"RateFunction","subTitle":"(background, front): ReactClass","properties":[{"name":"background","tag":{"cn":"未选中元素背景","en":"Unselected element background","default":"","version":""},"type":"ReactElement | string | Array<string | ReactElement>"},{"name":"front","tag":{"cn":"选中元素背景","en":"selected element background","default":"","version":""},"type":"ReactElement | string | Array<string | ReactElement>"}],"cn":"","en":""},{"title":"Rate","properties":[{"name":"size","tag":{"cn":"图标大小","en":"the size of the icon","default":"20","version":""},"type":"string | number "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"disabled","tag":{"cn":"是否只读","en":"read-only","default":"false","version":""},"type":"boolean "},{"name":"value","tag":{"cn":"选中的 key （受控)","en":"Selected key (controlled)","default":"","version":""},"type":"number"},{"name":"onChange","tag":{"cn":"值改变回调","en":"value change callback","default":"","version":""},"type":"(value: number) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"type":"((e?: Error ) => void) "},{"name":"filterSameChange","tag":{"cn":"当两次选择的值相同时不触发onChange","en":"onChange is not triggered when two selected values are the same","default":"false","version":""},"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值","en":"defaultValue","default":"","version":""},"type":"any"},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 Rule 用法","en":"Validation rules, see Rule usage for details","default":"","version":""},"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段,配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"type":"string | string[] "},{"name":"max","tag":{"cn":"选项最大值，整数","en":"The maximum value of the option, integer","default":"5","version":""},"type":"number "},{"name":"clearable","tag":{"cn":"是否允许再次点击后清除","en":"whether to allow clear when click again","default":"false","version":""},"type":"boolean "},{"name":"text","tag":{"cn":"附加文字","en":"Text","default":"","version":""},"type":"ReactNode[] "},{"name":"allowHalf","tag":{"cn":"是否允许半选","en":"Whether to allow semi selection","default":"false","version":""},"type":"boolean "},{"name":"repeat","tag":{"cn":"为 true 时，显示的选项为当前分值对应选项的复制","en":"When repeat is true, display item is a copy of the item corresponding to the current value","default":"true","version":""},"type":"boolean "}],"cn":"","en":""}]';
