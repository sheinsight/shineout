...
const api = '[{"title":"Carousel","properties":[{"name":"animation","tag":{"cn":"动画效果，可选值为 slide - 横向滑动 ，slide-y - 垂直滑动 ，fade - 淡入淡出","en":"animation effects, options: \\nslide - horizontal sliding\\nslide-y - vertical sliding\\nfade - fading","default":"\\\"slide\\\"","version":""},"type":"\\\"slide\\\" | \\\"slide-y\\\" | \\\"fade\\\" "},{"name":"indicatorPosition","tag":{"cn":"指示标示位置","en":"the position of indicator","default":"\\\"center\\\"","version":""},"type":"\\\"left\\\" | \\\"center\\\" | \\\"right\\\" "},{"name":"indicatorType","tag":{"cn":"指示标示样式，字符串可以是：[\\\"circle\\\", \\\"number\\\", \\\"line\\\"]，函数则可以自定义样式: (current, moveTo) => (<Component />)","en":"the style of indicator, string options: [\\\"circle\\\", \\\"number\\\", \\\"line\\\"], using function for custom styles","default":"\\\"circle\\\"","version":""},"type":"\\\"number\\\" | \\\"circle\\\" | ((current: number, moveTo: (index: number) => void) => ReactNode) | \\\"line\\\" "},{"name":"interval","tag":{"cn":"动画间隔时间，为 0 时，不自动播放","en":"the interval of animation, When it is not 0, play automatically","default":"0","version":""},"type":"number "},{"name":"onMove","tag":{"cn":"轮播后的回调","en":"move callback","default":"","version":""},"type":"((current: number, extra: { prev: number; direction: \\\"forward\\\" | \\\"backward\\\"; moveTo: (n: number) => void; }) => void) "},{"name":"children","tag":{"cn":"子元素","en":"children","default":"","version":""},"type":"ReactNode"},{"name":"showArrow","tag":{"cn":"切换箭头显示时机","en":"When to show the switch trigger","default":"","version":""},"type":"\\\"hover\\\" | \\\"always\\\" "},{"name":"arrowClassName","tag":{"cn":"箭头扩展 class","en":"The additional css class for arrow","default":"","version":""},"type":"string "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""}]';
