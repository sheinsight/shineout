...
const api = '[{"title":"CardGroup.Item","properties":[{"name":"value","tag":{"cn":"选中时返回值","en":"Specifies the result","default":"true"},"type":"any"},{"name":"onChange","tag":{"cn":"选中状态变化事件，checked表示选中状态，value代表对应的值","en":"check changed, value is the value props","default":""},"type":"(checked: boolean, value: Value) => void"},{"name":"disabled","tag":{"cn":"是否禁用选择框","en":"disable checkbox","default":"false"},"type":"boolean"},{"name":"placeholder","tag":{"cn":"懒加载占位元素，设置后卡片将开启懒加载","en":"lazy load placeholder, enable lazy load while set","default":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"children","tag":{"cn":"子元素","en":"children","default":""},"type":"ReactNode"},{"name":"checked","tag":{"cn":"checked 表示选中状态，不设置则不显示选择框","en":"checked status, hide while not set","default":""},"type":"boolean"}],"cn":"","en":""},{"title":"CardGroup","properties":[{"name":"height","tag":{"cn":"卡片组高度","en":"group height","default":""},"type":"number"},{"name":"cardWidth","tag":{"cn":"卡片最小宽度","en":"card min width","default":""},"type":"number"},{"name":"columns","tag":{"cn":"列数，设置 cardWidth 后该属性将失效","en":"items count each row, not work while cardWidth setted","default":"3"},"type":"number"},{"name":"gridStyle","tag":{"cn":"卡片网格样式","en":"grid style","default":""},"type":"CSSProperties"},{"name":"gutter","tag":{"cn":"卡片横向纵向间距，如果两个间距相互独立可以通过 gridStyle 调整","en":"gutter width horizontal and vertical, if diff shoud set gridStyle","default":"16"},"type":"number"},{"name":"children","tag":{"cn":"children","en":"子元素","default":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"}],"cn":"","en":""}]';
