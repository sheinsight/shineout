...
const api = '[{"title":"CardGroup.Item","properties":[{"name":"children","tag":{"en":"children","cn":"子元素"},"type":"ReactNode"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"},{"name":"placeholder","tag":{"en":"lazy load placeholder, enable lazy load while set","cn":"懒加载占位元素，设置后卡片将开启懒加载"},"type":"ReactNode"},{"name":"checked","tag":{"en":"checked status, hide while not set","cn":"checked 表示选中状态，不设置则不显示选择框"},"type":"boolean"},{"name":"disabled","tag":{"en":"disable checkbox","cn":"是否禁用选择框","default":"false"},"type":"boolean"},{"name":"value","tag":{"en":"Specifies the result","cn":"选中时返回值","default":"true","override":"any"},"type":"any"},{"name":"onChange","tag":{"en":"check changed, value is the value props","cn":"选中状态变化事件，checked表示选中状态，value代表对应的值"},"type":"(checked: boolean, value: Value) => void"}]},{"title":"CardGroup","properties":[{"name":"height","tag":{"en":"group height","cn":"卡片组高度"},"type":"number"},{"name":"cardWidth","tag":{"en":"card min width","cn":"卡片最小宽度"},"type":"number"},{"name":"columns","tag":{"en":"items count each row, not work while cardWidth setted","cn":"列数，设置 cardWidth 后该属性将失效","default":"3"},"type":"number"},{"name":"gridStyle","tag":{"en":"grid style","cn":"卡片网格样式"},"type":"CSSProperties"},{"name":"gutter","tag":{"en":"gutter width horizontal and vertical, if diff shoud set gridStyle","cn":"卡片横向纵向间距，如果两个间距相互独立可以通过 gridStyle 调整","default":"16"},"type":"number"},{"name":"children","tag":{"cn":"children","en":"子元素"},"type":"ReactNode"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"}]}]';
