...
const api = '[{"title":"Tooltip","properties":[{"name":"children","tag":{"cn":"子元素只能为一个 ReactElement","en":"The child element can only be a ReactElement.","default":"","version":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "},{"name":"tip","tag":{"cn":"弹出文字","en":"Pop up texts","default":"","version":""},"type":"ReactNode"},{"name":"position","tag":{"cn":"弹出层位置","en":"The position of the pop-up layer","default":"\\\"top\\\"","version":""},"type":"\\\"top\\\" | \\\"left\\\" | \\\"right\\\" | \\\"bottom\\\" | \\\"bottom-right\\\" | \\\"cover\\\" "},{"name":"trigger","tag":{"cn":"弹出方式","en":"Pop-up type","default":"\\\"hover\\\"","version":""},"type":"\\\"click\\\" | \\\"hover\\\" "},{"name":"delay","tag":{"cn":"弹出延迟","en":"Popup delay","default":"0","version":""},"type":"number "},{"name":"animation","tag":{"cn":"弹出是否使用动画","en":"use animation","default":"true","version":""},"type":"boolean "},{"name":"disabledChild","tag":{"cn":"使被禁用的元素正常显示提示","en":"make disabled element work","default":"false","version":""},"type":"boolean "}],"cn":"","en":""}]';
