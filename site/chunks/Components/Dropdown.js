...
const api = '[{"title":"DropDown","properties":[{"name":"columns","tag":{"cn":"页面多元素展示,此属性需要依赖width属性,请合理的设置列数和宽度","en":"Display multiple elements on the page. This property depends on the width attribute. Please set the number of columns and width appropriately.","default":""},"type":"number"},{"name":"outline","tag":{"cn":"同 Button","en":"same as Button","default":""},"type":"boolean"},{"name":"disabled","tag":{"cn":"禁用","en":"Specifies the dropdown should be disabled","default":"false"},"type":"boolean"},{"name":"animation","tag":{"cn":"是否开启动画","en":"Specifies the dropdown should be disabled","default":"true"},"type":"boolean"},{"name":"data","tag":{"cn":"下拉数据","en":"data of dropdown","default":"[]"},"type":"(DropdownNode | ReactNode)[]"},{"name":"trigger","tag":{"cn":"触发方式","en":"Toggle mode","default":"\\\"click\\\""},"type":"\\\"click\\\" | \\\"hover\\\""},{"name":"placeholder","tag":{"cn":"按钮显示内容","en":"Displayed content of the button","default":""},"type":"ReactNode"},{"name":"size","tag":{"cn":"同 Button","en":"same as Button","default":"\\\"default\\\""},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"type","tag":{"cn":"类型","en":"type of Dropdown","default":""},"type":"\\\"success\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"default\\\" | \\\"primary\\\" | \\\"secondary\\\" | \\\"link\\\""},{"name":"onClick","tag":{"cn":"点击事件。参数为渲染的数据,注: 如果数据内设置了onClick，会忽略此方法，调用data.onClick","en":"The click event. The parameter is the rendered data. <br /> Note: if the onClick is set in the data, this method will be ignored and data.onclick will be called.","default":""},"type":"(data: any) => void"},{"name":"width","tag":{"cn":"弹出选项层的宽度","en":"The width of the pop-up option layer","default":""},"type":"number"},{"name":"position","tag":{"cn":"弹出的方向和位置","en":"Set position property can control the direction and position of the drop-down menu","default":": \\\"auto\\\""},"type":"\\\"top-left\\\" | \\\"top-right\\\" | \\\"left-top\\\" | \\\"left-bottom\\\" | \\\"right-top\\\" | \\\"right-bottom\\\" | \\\"bottom-left\\\" | \\\"bottom-right\\\" | \\\"auto\\\""},{"name":"renderItem","tag":{"cn":"设置显示的内容,如果是字符串,则为对应的值。如果是函数,则返回值为显示的内容,参数为当条数据","en":"Set the displayed content. If it is a string,  the corresponding value will be displayed. \\n If it is a function, the return value will be displayed and its parameter is the current data.","default":""},"type":"string | ((data: any) => ReactNode)"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":""},"type":"CSSProperties"},{"name":"absolute","tag":{"cn":"为 true 时，选项弹出层在 DOM 中独立 render; 为函数时，返回值作为弹出层容器","en":"When it is true, the pop-up layer of option append into document.body; When it is a function, the return value is used as the popup layer container","default":"false"},"type":"boolean | (() => HTMLElement)"}],"cn":"","en":""},{"title":"DropdownNode","properties":[{"name":"url","tag":{"cn":"url属性不为空时，render为一个链接","en":"When the url is not empty, a url will be rendered.","default":""},"type":"string"},{"name":"target","tag":{"cn":"url 不为空时有效","en":"It is valid when the url is not empty.","default":""},"type":"string"},{"name":"disabled","tag":{"cn":"禁用","en":"Disabled","default":""},"type":"boolean"},{"name":"content","tag":{"cn":"默认从content获取内容","en":"element","default":""},"type":"ReactNode"},{"name":"children","tag":{"cn":"子节点","en":"childNode","default":""},"type":"DropdownNode[]"},{"name":"onClick","tag":{"cn":"点击事件","en":"click event","default":""},"type":"(data: DropdownNode) => void"}],"cn":"data 选项有三种情况：\\n  为 ReactElement 时，直接显示此元素；\\n  为 object 且设置了 renderItem，显示 renderItem 返回的内容；\\n  为 object 且未设置 renderItem，按以下数据结构处理。","en":"If data item is a ReactElement, render the item;\\nIf data item is an object and renderItem is set, render the renderItem\\\"s result;\\nif data item is an object and renderItem is not set, handle the parameters as follows;"}]';
