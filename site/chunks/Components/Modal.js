...
const api = '[{"title":"Modal","properties":[{"name":"forceMask","tag":{"cn":"是否强制设置遮罩透明度（多层Modal中，除第一层外的其他Modal遮罩透明度会被调整为0.01）","en":"Whether to force the mask transparency (in multi-layer Modal, the transparency of other Modal masks except the first layer will be adjusted to 0.01)","default":"false","version":""},"required":false,"type":"boolean "},{"name":"top","tag":{"cn":"模态框距离顶部距离","en":"Distance from top","default":"10vh","version":""},"required":false,"type":"string | number "},{"name":"fullScreen","tag":{"cn":"是否全屏展示","en":"display modal with full screen","default":"false","version":""},"required":false,"type":"boolean "},{"name":"bodyStyle","tag":{"cn":"扩展 modal body 的样式","en":"Extend modal body style","default":"","version":""},"required":false,"type":"CSSProperties "},{"name":"footer","tag":{"cn":"底部内容","en":"The content at the bottom","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"maskCloseAble","tag":{"cn":"点击遮罩层是否关闭对话框, 设置为 null 右上角关闭图标会保留","en":"Whether to close the mask when the mask is clicked","default":"true","version":""},"required":false,"type":"boolean | null "},{"name":"maskOpacity","tag":{"cn":"遮罩层透明度","en":"The opacity of the mask","default":"0.25","version":""},"required":false,"type":"number "},{"name":"padding","tag":{"cn":"内容内边距","en":"Padding style of the content","default":"","version":""},"required":false,"type":"string | number "},{"name":"position","tag":{"cn":"弹出位置","en":"Pop-up position","default":"","version":""},"required":false,"type":"\\\"bottom\\\" | \\\"left\\\" | \\\"right\\\" | \\\"top\\\" "},{"name":"title","tag":{"cn":"弹出层的标题","en":"the title of the pop-up layer","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"usePortal","tag":{"cn":"为 true 时，使用 ReactDOM.createPortal 创建弹出层，为 false 时，使用 ReactDOM.render。函数式调用时使用 ReactDOM.render。","en":"When the usePortal is true, use ReactDOM.createPortal to create the pop-up layer, otherwise use ReactDOM.render. Use ReactDOM.render while func call.","default":"true","version":""},"required":false,"type":"boolean "},{"name":"visible","tag":{"cn":"是否显示","en":"visible","default":"false","version":""},"required":false,"type":"boolean "},{"name":"width","tag":{"cn":"对话框宽度 （仅在常规对话框下生效）","en":"the width of the Modal ( only works under normal modal )","default":"500","version":""},"required":false,"type":"string | number "},{"name":"zIndex","tag":{"cn":"对话框 z-index 值，注意：如 Modal 嵌套 Select 组件，并且 Select 组件含有 absolute 字段，需要修改 Select 的 z-index的值","en":"Modal z-index","default":"1050","version":""},"required":false,"type":"number "},{"name":"rootClassName","tag":{"cn":"modal 的根元素类名, 为遮罩层的父元素","en":"the root element of modal, the mask parent element","default":"","version":"1.4.2"},"required":false,"type":"string "},{"name":"container","tag":{"cn":"渲染的目标节点","en":"target element","default":"document.body","version":""},"required":false,"type":"HTMLElement | (() => HTMLElement) "},{"name":"moveable","tag":{"cn":"是否可移动","en":"modal support move","default":"false","version":""},"required":false,"type":"boolean "},{"name":"maskBackground","tag":{"cn":"遮罩背景色，设置后透明度将失效","en":"mask background","default":"","version":""},"required":false,"type":"string "},{"name":"onClose","tag":{"cn":"模态框关闭回调","en":"modal close callback","default":"","version":""},"required":false,"type":"(() => void) "},{"name":"destroy","tag":{"cn":"关闭时是否销毁元素","en":"Whether to destroy elements when it is closed","default":"false","version":""},"required":false,"type":"boolean "},{"name":"hideClose","tag":{"cn":"是否隐藏关闭按钮","en":"hide the close button","default":"","version":""},"required":false,"type":"boolean "},{"name":"type","tag":{"cn":"Modal title 显示状态icon","en":"Modal Title show status icon","default":"","version":"1..6.1"},"required":false,"type":"\\\"error\\\" | \\\"default\\\" | \\\"success\\\" | \\\"warning\\\" | \\\"info\\\" | \\\"normal\\\" "},{"name":"zoom","tag":{"cn":"是否开启 zoom 动画效果","en":"toggle zoom animation","default":"false","version":""},"required":false,"type":"boolean "},{"name":"esc","tag":{"cn":"是否支持 esc 键关闭","en":"press \\\"esc\\\" to close","default":"true","version":""},"required":false,"type":"boolean "},{"name":"events","tag":{"cn":"外层元素所接受的事件列表，可用于在 createPortal 场景中阻止冒泡","en":"events list of container element","default":"{}","version":""},"required":false,"type":"object "},{"name":"resizable","tag":{"cn":"是否可调整大小","en":"can resize","default":"false","version":""},"required":false,"type":"boolean "},{"name":"noPadding","tag":{"cn":"当Sheinout采用 antd 主题时，取消内容区域的padding","en":"When the theme is antd, Set the content style padding to 0","default":"","version":""},"required":false,"type":"boolean "},{"name":"height","tag":{"cn":"对话框高度 （仅在常规对话框下生效）","en":"the height of the Modal ( only works under normal modal )","default":"","version":""},"required":false,"type":"string | number "},{"name":"children","tag":{"cn":"Modal children","en":"Modal 内容","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "}],"cn":"","en":""},{"title":"ModalMethods","properties":[{"name":"content","tag":{"cn":"提示内容主体","en":"Content body","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"onCancel","tag":{"cn":"点击取消按钮时触发事件，仅在 confirm 方法中有效","en":"The event is triggered when the cancel button is clicked.","default":"","version":""},"required":false,"type":"(() => void) "},{"name":"onClose","tag":{"cn":"关闭Modal时触发","en":"The event is triggered when the modal is closed.","default":"","version":""},"required":false,"type":"(() => void) "},{"name":"onOk","tag":{"cn":"点击确定按钮时触发事件，返回 Promise 时，会在 Promise resolve 后关闭Modal","en":"The event is triggered when the ok button is clicked.","default":"","version":""},"required":false,"type":"(() => void | Promise<any>) "},{"name":"text","tag":{"cn":"按钮文字","en":"The text of button","default":"{ ok: \\\"Ok\\\", cancel: \\\"Cancel\\\" }","version":""},"required":false,"type":"{ ok?: string ; cancel?: string ; } "},{"name":"autoFocusButton","tag":{"cn":"默认聚焦的按钮, 可选值 [\\\"ok\\\", \\\"cancel\\\"]","en":"auto focus button, one of [\\\"ok\\\", \\\"cancel\\\"]","default":"","version":""},"required":false,"type":"string "}],"cn":"","en":""}]';
