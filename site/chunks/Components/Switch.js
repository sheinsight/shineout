...
const examples = [
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Switch/example-1-base.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Switch/example-2-disabled.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Switch/example-3-content.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Switch/example-4-size.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Switch/example-5-loading.tsx'),
...
const api = '[{"title":"Switch","properties":[{"name":"className","tag":{"cn":"扩展 className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "},{"name":"checked","tag":{"cn":"当前选中状态，checked 传入时为受控组件","en":"checked status，will in control when pass","default":"","version":""},"required":false,"type":"boolean "},{"name":"disabled","tag":{"cn":"是否禁用","en":"disable checkbox","default":"false","version":""},"required":false,"type":"boolean "},{"name":"value","tag":{"cn":"checked 未设置的情况下， checked = value","en":"set while no checked","default":"","version":""},"required":false,"type":"boolean "},{"name":"onChange","tag":{"cn":"checked 表示选中状态","en":"checked is status","default":"","version":""},"required":false,"type":"((value: boolean) => void) "},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"required":false,"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"required":false,"type":"((e?: Error ) => void) "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合 Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"required":false,"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值  和 value 类型相同","en":"defaultValue 和 value 类型相同","default":"","version":""},"required":false,"type":"Value "},{"name":"reserveAble","tag":{"cn":"设置为 true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"required":false,"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 [Rule](/components/rule)","en":"Validation rules, see [Rule](/components/rule) usage for details","default":"","version":""},"required":false,"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段, 配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"required":false,"type":"string "},{"name":"size","tag":{"cn":"尺寸","en":"size","default":"\\\"default\\\"","version":""},"required":false,"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"loading","tag":{"cn":"加载中","en":"loading","default":"false","version":""},"required":false,"type":"boolean "},{"name":"content","tag":{"cn":"选中和未选中时的内容","en":"content with checked and unchecked","default":"","version":""},"required":false,"type":"[ReactNode, ReactNode] "},{"name":"onClick","tag":{"cn":"勾选框点击回调","en":"Checkbox click callback","default":"","version":""},"required":false,"type":"MouseEventHandler<HTMLInputElement> "}],"cn":"","en":""}]';
