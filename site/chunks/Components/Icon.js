...
const api = '[{"title":"Icon","subTitle":"function(url, fontFamily, prefix):ReactClass","properties":[{"name":"url","tag":{"cn":"图标css或js文件地址，使用在线地址，不需要引入到项目中。如果在 link或script 中已经引用过，可以为空(null)","en":"The address of css or js file of the icon. If it has been introduced in the link/script tag, it can be empty.","default":"","version":""},"type":"string"},{"name":"fontFamily","tag":{"cn":"The font-family needs to be the same as the font-family in the introduced CSS/JS file.","en":"font-family 需要和引入的css/js文件内的font-family一致","default":"\\\"iconfont\\\"","version":""},"type":"string "},{"name":"prefix","tag":{"cn":"类名前缀","en":"The prefix of the class","default":"\\\"icon\\\"","version":""},"type":"string "}],"cn":"函数，返回一个新的组件，一个项目内可以创建多个，但是 fontFamily 不能相同","en":"Function, returns a new component. A project can create more than one, but fontFamily must be the unique."},{"title":"MyIcon","properties":[{"name":"children","tag":{"cn":"图标 unicode 编码，和 name 二选一","en":"The unicode code of the icon.","default":"","version":""},"type":"ReactNode"},{"name":"name","tag":{"cn":"图标类名（去除前缀的部分），值参照具体使用的图标库","en":"Icon class name (the part without the prefix)","default":"","version":""},"type":"string "},{"name":"fontSize","tag":{"cn":"图标大小，和 style.fontSize 相同","en":"Icon size, same as style.fontsize","default":"","version":""},"type":"string | number "},{"name":"type","tag":{"cn":"内置颜色类型","en":"Built-in color type","default":"\\\"default\\\"","version":""},"type":"\\\"union"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"Icon函数创建的图标组件","en":"Component created by the Icon function"}]';
