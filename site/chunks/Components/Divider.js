...
const examples = [
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Divider/example-1-base.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Divider/example-2-base.tsx'),
  ...
  },
  {
    ...
    parseTsText: require('!raw-loader!doc/pages/components/Divider/example-3-base.tsx'),
...
const api = '[{"title":"Divider","properties":[{"name":"children","tag":{"cn":"分割线中文字内容","en":"Content, text or react component","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"mode","tag":{"cn":"分割线排布模式","en":"mode of divider","default":"\\\"horizontal\\\"","version":""},"required":false,"type":"\\\"horizontal\\\" | \\\"vertical\\\" "},{"name":"orientation","tag":{"cn":"水平分割线的文字排布位置","en":"The position of title inside divider","default":"\\\"center\\\"","version":""},"required":false,"type":"\\\"left\\\" | \\\"center\\\" | \\\"right\\\" "},{"name":"className","tag":{"cn":"扩展 className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "}],"cn":"","en":""}]';
