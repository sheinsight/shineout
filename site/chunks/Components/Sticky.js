...
const api = '[{"title":"Sticky","properties":[{"name":"style","tag":{"cn":"扩展样式。触发浮动后的默认zIndex为900，修改style的zIndex来改变。","en":"Extend style. \bThe default z-Index after triggering the float is 900, and you can modify the z-Index of the style to change.","default":"","version":""},"type":"CSSProperties "},{"name":"bottom","tag":{"cn":"距离底部多少偏移量触发","en":"Offsets from the bottom.","default":"","version":""},"type":"number "},{"name":"target","tag":{"cn":"附着的目标，默认为document.body。可以传入HTMLElement或者css selector，target 必须为 Sticky 组件的祖先节点","en":"Attached target. the default is the document.body. You can pass in an HTMLElement or css selector, and the target must be an ancestor node of the Sticky component.","default":"","version":""},"type":"string | HTMLElement "},{"name":"top","tag":{"cn":"距离顶部多少偏移量触发","en":"Offsets from the top.","default":"","version":""},"type":"number "},{"name":"css","tag":{"cn":"在指定 target 下，是否采用css方式实现附着效果","en":"use css position:sticky while target is ordered","default":"true","version":""},"type":"boolean "},{"name":"onChange","tag":{"cn":"吸附效果时，触发该回调","en":"When the adsorption effect, trigger the callback","default":"","version":""},"type":"((isSticky: boolean) => void) "},{"name":"children","tag":{"cn":"子元素","en":"children","default":"","version":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "}],"cn":"","en":""}]';
