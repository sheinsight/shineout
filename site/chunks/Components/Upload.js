...
const api = '[{"title":"Upload","properties":[{"name":"value","tag":{"cn":"defaultValue 和 value 可以同时设置，defaultValue 会被value覆盖 在 Form 中，value会被表单接管，value 无效","en":"value","default":"","version":""},"type":"any[]"},{"name":"onChange","tag":{"cn":"值改变回调(上传成功，删除)。values: 数组, 其每个值是 onSuccess 的返回值","en":"The callback function when the value is changing(Upload successfully, delete). values: Array, the value is the onSuccess returns","default":"","version":""},"type":"(values: ValueItem[]) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"上传出错事件(props 中为 onHttpError)","en":"onError callback","default":"","version":""},"type":"((xhr: Xhr, file: File) => string ) "},{"name":"disabled","tag":{"cn":"是否禁用","en":"is disabled","default":"false","version":""},"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值  和 value 类型相同","en":"defaultValue 和 value 类型相同","default":"","version":""},"type":"Value "},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 Rule 用法","en":"Validation rules, see Rule usage for details","default":"","version":""},"type":"RuleItem[]"},{"name":"name","tag":{"cn":"Form 内存取数据的 key","en":"The key access data in the Form","default":"","version":""},"type":"string "},{"name":"forceAccept","tag":{"cn":"在使用时关闭了 accept 提供的文件类型过滤后，强制对文件类型进行校验（值同accept)","en":"After disabled the file type filtering provided by accept, it is mandatory to check the file type, value same as accept","default":"","version":""},"type":"string "},{"name":"accept","tag":{"cn":"上传文件类型, 和标准一致, 详见[accept](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/file#accept)","en":"The type of the upload file, same as the standard,See details [accept](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/file#accept)","default":"","version":""},"type":"string "},{"name":"action","tag":{"cn":"上传地址","en":"The address for uploading","default":"","version":""},"type":"string | ((file: File) => string) "},{"name":"beforeUpload","tag":{"cn":"上传前的回调","en":"The callback of before upload","default":"","version":""},"type":"((file: File, validatorHandle: (error: Error, file: File) => boolean) => Promise<any>) "},{"name":"children","tag":{"cn":"上传占位内容","en":"Upload placeholder","default":"\\\"required\\\"","version":""},"type":"ReactNode"},{"name":"headers","tag":{"cn":"请求头部信息","en":"Request headers","default":"","version":""},"type":"{ [name: string]: V } "},{"name":"htmlName","tag":{"cn":"服务端接收的 filename，不填使用 name","en":"The filename received by the server. If it is not filled in, use the name.","default":"","version":""},"type":"string "},{"name":"limit","tag":{"cn":"最大上传文件数","en":"Maximum number of uploaded files","default":"100","version":""},"type":"number "},{"name":"multiple","tag":{"cn":"是否支持多选文件","en":"Whether multi-select files are supported","default":"false","version":""},"type":"boolean "},{"name":"onProgress","tag":{"cn":"上传中进度","en":"onProgress","default":"","version":""},"type":"false | ((fileInfo: {  name: string, process: number, status: number, blob: File, xhr?: void | Xhr , message?: string  }) => any) "},{"name":"onSuccess","tag":{"cn":"上传成功事件","en":"onSuccess","default":"","version":""},"type":"((res: any, file: File, data?: any, xhr?: Xhr ) => ValueItem | Error) "},{"name":"onHttpError","tag":{"cn":"上传失败时回调，返回结果作为错误内容提示","en":"The callback function when to upload unsuccessfully. The returned result is as the error message.","default":"","version":""},"type":"((xhr: Xhr, file: File) => string ) "},{"name":"beforeCancel","tag":{"cn":"取消文件上传前的回调","en":"The callback function before cancel upload file.","default":"","version":""},"type":"((xhr: Xhr) => void) "},{"name":"params","tag":{"cn":"提交到服务端的额外参数","en":"Additional parameters submitted to the server","default":"","version":""},"type":"{ [name: string]: V } "},{"name":"recoverAble","tag":{"cn":"是否可以恢复已删除的value","en":"Whether to recover deleted values.","default":"true","version":""},"type":"boolean "},{"name":"renderResult","tag":{"cn":"结果展示","en":"Display results","default":"a => a","version":""},"type":"((data: any) => ReactNode) "},{"name":"request","tag":{"cn":"自定义上传方法。 options: 上传的配置","en":"Custom upload method. options: the options of upload","default":"","version":""},"type":"(options: UploadOptions) => Xhr | void"},{"name":"validator","tag":{"cn":"上传前文件校验","en":"Check file before uploading","default":"","version":""},"type":"{  customValidator?: ((file: File) => void | Error | Promise<any>) , ext?: ((ext: string) => void | Error | Promise<any>) , imageSize?: ((image: { width: number; height: number; }) => void | Error) , size?: ((size: number) => void | Error | Promise<any>)  } "},{"name":"customResult","tag":{"cn":"自定义Result 组件","en":"custom Result component","default":"","version":""},"type":"ComponentType<{ value: any; files: any; onValueRemove: (index: number) => void; onFileRemove: (id: string) => void; }> "},{"name":"withCredentials","tag":{"cn":"是否携带 cookie","en":"Whether to take the cookie","default":"false","version":""},"type":"boolean "},{"name":"onStart","tag":{"cn":"开始上传的回调函数","en":"callback when start","default":"","version":""},"type":"((file: File) => void) "},{"name":"showUploadList","tag":{"cn":"是否展示上传列表","en":"show upload list","default":"true","version":""},"type":"boolean "},{"name":"validatorHandle","tag":{"cn":"是否处理校验失败的情况, 如果提供一个函数, 则以函数的返回值判断是否处理此 error","en":"Whether to handle the case of validation failure, if a function is provided, it is judged by the return value of the function.","default":"true","version":""},"type":"boolean | ((error: any, file: File) => boolean) "},{"name":"webkitdirectory","tag":{"cn":"同原生 input 标签的 webkitdirectory 属性","en":"The same as the native webkitdirectory tag","default":"","version":""},"type":"string | boolean "},{"name":"renderContent","tag":{"cn":"自定义结果的内容","en":"Custom content of result","default":"","version":""},"type":"((res: any, value: ValueItem, index: number, values: ValueItem[]) => ReactNode) "},{"name":"drop","tag":{"cn":"是否开启拖拽上传文件","en":"drop to update","default":"false","version":""},"type":"boolean "},{"name":"filesFilter","tag":{"cn":"文件选中后的筛选，用户可自定义最终需要上传的文件列表。需返回一个新的文件列表","en":"Filter after file selection, users can customize the list of files that need to be uploaded eventually. Need to return a new file list","default":"","version":""},"type":"((fileList: File[]) => File[]) "},{"name":"onErrorRemove","tag":{"cn":"上传失败图片删除之后的回调","en":"remove update failed callback","default":"","version":""},"type":"((xhr: Xhr, file: File, fileInfo?: any) => void) "},{"name":"onPreview","tag":{"cn":"自定义预览图片操作，默认为画廊展示","en":"how to preview the image","default":"","version":""},"type":"((url: string, value: ValueItem, index: number, values: ValueItem[], fun: { preview: () => void; }) => void) "},{"name":"removeConfirm","tag":{"cn":"是否在删除文件和图片前弹出确认","en":"Confirmation before deletion","default":"","version":""},"type":"string | PopoverConfirmProps "},{"name":"beforeRemove","tag":{"cn":"删除前的确认，返回一个Promise用于最终确定是否删除","en":"callback before remove","default":"","version":""},"type":"((value: ValueItem) => Promise<any>) "},{"name":"forceAcceptErrorMsg","tag":{"cn":"forceAccept 类型校验失败后自定义错误提示","en":"Custom error prompt after forceAccept type verification fails","default":"","version":""},"type":"string "},{"name":"canDelete","tag":{"cn":"文件是否可以删除","en":"Can the file be deleted","default":"true","version":""},"type":"boolean | ((value: ValueItem, index: number) => boolean) "},{"name":"gapProps","tag":{"cn":"调整间距 同 Gap 属性","en":"Adjust the spacing to be consistent with the Gap props","default":"{column: 12, row: 12}","version":""},"type":"GapProps "},{"name":"responseType","tag":{"cn":"设置 xhr.responseType","en":"set xhr.responseType","default":"","version":""},"type":"XMLHttpRequestResponseType "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "}],"cn":"","en":""},{"title":"Upload.Image","properties":[{"name":"leftHandler","tag":{"cn":"添加图片视图是否在左侧展示","en":"Add image view is displayed on the left","default":"false","version":""},"type":"boolean "},{"name":"height","tag":{"cn":"同 style.height","en":"same as style.height","default":"","version":""},"type":"number "},{"name":"width","tag":{"cn":"同 style.width","en":"same as style.width","default":"","version":""},"type":"number "},{"name":"ignorePreview","tag":{"cn":"是否忽略上传图片预览","en":"ignore image preview","default":"false","version":""},"type":"boolean "}],"cn":"基本 API 和 Upload 相同，特定的 API 如下：","en":"The basic API is the same as Upload, and the specific API is as follows:"},{"title":"Upload.Button","properties":[{"name":"forceAccept","tag":{"cn":"在使用时关闭了 accept 提供的文件类型过滤后，强制对文件类型进行校验（值同accept)","en":"After disabled the file type filtering provided by accept, it is mandatory to check the file type, value same as accept","default":"","version":""},"type":"string "},{"name":"value","tag":{"cn":"defaultValue 和 value 可以同时设置，defaultValue 会被value覆盖 在 Form 中，value会被表单接管，value 无效","en":"value","default":"","version":""},"type":"any[]"},{"name":"onChange","tag":{"cn":"值改变回调(上传成功，删除)。values: 数组, 其每个值是 onSuccess 的返回值","en":"The callback function when the value is changing(Upload successfully, delete). values: Array, the value is the onSuccess returns","default":"","version":""},"type":"(values: ValueItem[]) => void"},{"name":"onError","tag":{"cn":"上传出错事件(props 中为 onHttpError)","en":"onError callback","default":"","version":""},"type":"((xhr: Xhr, file: File) => string ) "},{"name":"disabled","tag":{"cn":"是否禁用","en":"is disabled","default":"false","version":""},"type":"boolean "},{"name":"name","tag":{"cn":"Form 内存取数据的 key","en":"The key access data in the Form","default":"","version":""},"type":"string "},{"name":"accept","tag":{"cn":"上传文件类型, 和标准一致, 详见[accept](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/file#accept)","en":"The type of the upload file, same as the standard,See details [accept](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/file#accept)","default":"","version":""},"type":"string "},{"name":"action","tag":{"cn":"上传地址","en":"The address for uploading","default":"","version":""},"type":"string | ((file: File) => string) "},{"name":"beforeUpload","tag":{"cn":"上传前的回调","en":"The callback of before upload","default":"","version":""},"type":"((file: File, validatorHandle: (error: Error, file: File) => boolean) => Promise<any>) "},{"name":"children","tag":{"cn":"上传占位内容","en":"Upload placeholder","default":"\\\"required\\\"","version":""},"type":"ReactNode"},{"name":"headers","tag":{"cn":"请求头部信息","en":"Request headers","default":"","version":""},"type":"{ [name: string]: V } "},{"name":"htmlName","tag":{"cn":"服务端接收的 filename，不填使用 name","en":"The filename received by the server. If it is not filled in, use the name.","default":"","version":""},"type":"string "},{"name":"limit","tag":{"cn":"最大上传文件数","en":"Maximum number of uploaded files","default":"100","version":""},"type":"number "},{"name":"multiple","tag":{"cn":"是否支持多选文件","en":"Whether multi-select files are supported","default":"false","version":""},"type":"boolean "},{"name":"onProgress","tag":{"cn":"上传中进度","en":"onProgress","default":"","version":""},"type":"false | ((fileInfo: {  name: string, process: number, status: number, blob: File, xhr?: void | Xhr , message?: string  }) => any) "},{"name":"onSuccess","tag":{"cn":"上传成功事件","en":"onSuccess","default":"","version":""},"type":"((res: any, file: File, data?: any, xhr?: Xhr ) => ValueItem | Error) "},{"name":"onHttpError","tag":{"cn":"上传失败时回调，返回结果作为错误内容提示","en":"The callback function when to upload unsuccessfully. The returned result is as the error message.","default":"","version":""},"type":"((xhr: Xhr, file: File) => string ) "},{"name":"beforeCancel","tag":{"cn":"取消文件上传前的回调","en":"The callback function before cancel upload file.","default":"","version":""},"type":"((xhr: Xhr) => void) "},{"name":"params","tag":{"cn":"提交到服务端的额外参数","en":"Additional parameters submitted to the server","default":"","version":""},"type":"{ [name: string]: V } "},{"name":"recoverAble","tag":{"cn":"是否可以恢复已删除的value","en":"Whether to recover deleted values.","default":"true","version":""},"type":"boolean "},{"name":"renderResult","tag":{"cn":"结果展示","en":"Display results","default":"a => a","version":""},"type":"((data: any) => ReactNode) "},{"name":"request","tag":{"cn":"自定义上传方法。 options: 上传的配置","en":"Custom upload method. options: the options of upload","default":"","version":""},"type":"(options: UploadOptions) => Xhr | void"},{"name":"validator","tag":{"cn":"上传前文件校验","en":"Check file before uploading","default":"","version":""},"type":"{  customValidator?: ((file: File) => void | Error | Promise<any>) , ext?: ((ext: string) => void | Error | Promise<any>) , imageSize?: ((image: { width: number; height: number; }) => void | Error) , size?: ((size: number) => void | Error | Promise<any>)  } "},{"name":"customResult","tag":{"cn":"自定义Result 组件","en":"custom Result component","default":"","version":""},"type":"ComponentType<{ value: any; files: any; onValueRemove: (index: number) => void; onFileRemove: (id: string) => void; }> "},{"name":"withCredentials","tag":{"cn":"是否携带 cookie","en":"Whether to take the cookie","default":"false","version":""},"type":"boolean "},{"name":"onStart","tag":{"cn":"开始上传的回调函数","en":"callback when start","default":"","version":""},"type":"((file: File) => void) "},{"name":"showUploadList","tag":{"cn":"是否展示上传列表","en":"show upload list","default":"true","version":""},"type":"boolean "},{"name":"validatorHandle","tag":{"cn":"是否处理校验失败的情况, 如果提供一个函数, 则以函数的返回值判断是否处理此 error","en":"Whether to handle the case of validation failure, if a function is provided, it is judged by the return value of the function.","default":"true","version":""},"type":"boolean | ((error: any, file: File) => boolean) "},{"name":"webkitdirectory","tag":{"cn":"同原生 input 标签的 webkitdirectory 属性","en":"The same as the native webkitdirectory tag","default":"","version":""},"type":"string | boolean "},{"name":"renderContent","tag":{"cn":"自定义结果的内容","en":"Custom content of result","default":"","version":""},"type":"((res: any, value: ValueItem, index: number, values: ValueItem[]) => ReactNode) "},{"name":"drop","tag":{"cn":"是否开启拖拽上传文件","en":"drop to update","default":"false","version":""},"type":"boolean "},{"name":"filesFilter","tag":{"cn":"文件选中后的筛选，用户可自定义最终需要上传的文件列表。需返回一个新的文件列表","en":"Filter after file selection, users can customize the list of files that need to be uploaded eventually. Need to return a new file list","default":"","version":""},"type":"((fileList: File[]) => File[]) "},{"name":"onErrorRemove","tag":{"cn":"上传失败图片删除之后的回调","en":"remove update failed callback","default":"","version":""},"type":"((xhr: Xhr, file: File, fileInfo?: any) => void) "},{"name":"onPreview","tag":{"cn":"自定义预览图片操作，默认为画廊展示","en":"how to preview the image","default":"","version":""},"type":"((url: string, value: ValueItem, index: number, values: ValueItem[], fun: { preview: () => void; }) => void) "},{"name":"removeConfirm","tag":{"cn":"是否在删除文件和图片前弹出确认","en":"Confirmation before deletion","default":"","version":""},"type":"string | PopoverConfirmProps "},{"name":"beforeRemove","tag":{"cn":"删除前的确认，返回一个Promise用于最终确定是否删除","en":"callback before remove","default":"","version":""},"type":"((value: ValueItem) => Promise<any>) "},{"name":"forceAcceptErrorMsg","tag":{"cn":"forceAccept 类型校验失败后自定义错误提示","en":"Custom error prompt after forceAccept type verification fails","default":"","version":""},"type":"string "},{"name":"canDelete","tag":{"cn":"文件是否可以删除","en":"Can the file be deleted","default":"true","version":""},"type":"boolean | ((value: ValueItem, index: number) => boolean) "},{"name":"gapProps","tag":{"cn":"调整间距 同 Gap 属性","en":"Adjust the spacing to be consistent with the Gap props","default":"{column: 12, row: 12}","version":""},"type":"GapProps "},{"name":"responseType","tag":{"cn":"设置 xhr.responseType","en":"set xhr.responseType","default":"","version":""},"type":"XMLHttpRequestResponseType "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"type":"CSSProperties "},{"name":"placeholder","tag":{"cn":"按钮默认内容","en":"button default content","default":"","version":""},"type":"ReactNode"},{"name":"loading","tag":{"cn":"上传中按钮的内容，如果是字符串默认会有spin loading","en":"content of uploading, will have spin if a string","default":"","version":""},"type":"ReactNode"},{"name":"size","tag":{"cn":"按钮尺寸","en":"size of button","default":"\\\"default\\\"","version":""},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"type","tag":{"cn":"按钮类型","en":"type of button","default":"\\\"default\\\"","version":""},"type":"\\\"default\\\" | \\\"primary\\\" | \\\"secondary\\\" | \\\"success\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"link\\\""},{"name":"outline","tag":{"cn":"outline 为 true 时，显示透明背景的按钮","en":"When outline is true, the background is transparent.","default":"false","version":""},"type":"boolean "}],"cn":"基本 API 和 Upload 相同，特定的 API 如下：","en":"The basic API is the same as Upload, and the specific API is as follows:"},{"title":"UploadOptions","properties":[{"name":"url","tag":{"cn":"上传地址从 action 中获取","en":"The upload address can be obtained from action","default":"","version":""},"type":"string"},{"name":"name","tag":{"cn":"formData 中存的字段名","en":"key of formData","default":"","version":""},"type":"string"},{"name":"withCredentials","tag":{"cn":"通过 props 中的 withCredentials","en":"same as withCredentials in props","default":"","version":""},"type":"boolean "},{"name":"responseType","tag":{"cn":"通过 props 中的 responseType","en":"same as responseType in props","default":"","version":""},"type":"XMLHttpRequestResponseType "},{"name":"file","tag":{"cn":"传入文件","en":"incoming file","default":"","version":""},"type":"File"},{"name":"headers","tag":{"cn":"请求头部信息","en":"request header information","default":"","version":""},"type":"object"},{"name":"onError","tag":{"cn":"上传出错事件(props 中为 onHttpError)","en":"onError callback","default":"","version":""},"type":"(xhr: Partial<Xhr>) => void"},{"name":"onLoad","tag":{"cn":"上传事件","en":"onLoad","default":"","version":""},"type":"(xhr?: Xhr ) => void"},{"name":"onProgress","tag":{"cn":"上传中进度","en":"onProgress","default":"","version":""},"type":"(event?: ProgressEvent<EventTarget> , msg?: string ) => any"},{"name":"onStart","tag":{"cn":"开始上传事件","en":"onStart","default":"","version":""},"type":"((file: File) => void) "},{"name":"onSuccess","tag":{"cn":"上传成功事件","en":"onSuccess","default":"","version":""},"type":"((res?: string , file?: File , data?: any, xhr?: Xhr ) => Error | T) "},{"name":"params","tag":{"cn":"上传参数","en":"params","default":"","version":""},"type":"{ [name: string]: V } "}],"cn":"","en":""},{"title":"Validator","properties":[{"name":"customValidator","tag":{"cn":"自定义校验","en":"custom validator","default":"","version":""},"type":"((file: File) => void | Error | Promise<any>) "},{"name":"ext","tag":{"cn":"判断后缀名，传入参数为文件后缀，校验失败返回 Error","en":"Judge the file extension, return the Error when the verification fails.","default":"","version":""},"type":"((ext: string) => void | Error | Promise<any>) "},{"name":"imageSize","tag":{"cn":"只对 Image 有效，判断图片尺寸，校验失败返回 Error","en":"It is only valid for Image to determine the size of images and return the Error when the verification fails.","default":"","version":""},"type":"(image: { width: number; height: number; }) => void | Error"},{"name":"size","tag":{"cn":"判断文件大小，校验失败返回 Error","en":"Judge the size of the file and return the Error when the verification fails.","default":"","version":""},"type":"((size: number) => void | Error | Promise<any>) "}],"cn":"","en":""}]';
