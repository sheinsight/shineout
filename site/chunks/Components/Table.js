...
const examples = [
  ...
  },
  {
    ...
    component: require('doc/pages/components/Table/example-30-multiple-sort.js').default,
    rawText: require('!raw-loader!doc/pages/components/Table/example-30-multiple-sort.js'),
  },
  {
    name: '99-raw',
    title: locate(
