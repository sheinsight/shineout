...
const api = '[{"title":"Cascader","properties":[{"name":"value","tag":{"cn":"选中的 key （受控)","en":"Selected key (controlled)","default":"","version":""},"required":false,"type":"Value "},{"name":"onChange","tag":{"cn":"设置 onChange 属性时，显示 选择框。参数为当前选中值，和 mode 属性相关","en":"When the onChange property is set, the selection box is displayed. The parameter is the current selected value, which is related to the mode property.","default":"","version":""},"required":false,"type":"(value: Value, selected?: DataItem ) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"required":false,"type":"(value: any , datum?: FormDatum) => any"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"required":false,"type":"((e?: Error ) => void) "},{"name":"popover","tag":{"cn":"信息弹出位置，参考 [Popover](/components/Popover)","en":"The position where the text pop up, see [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps[\\\"position\\\"]"},{"name":"disabled","tag":{"cn":"如果 disabled 为 true，禁用全部选项，如果 disabled 为函数，根据函数反回结果禁用选项","en":"When it is true, all nodes disable the selection; when it is a function, it determines whether it is disabled according to the return result of the function.","default":"false","version":""},"required":false,"type":"boolean | ((data: DataItem) => boolean) "},{"name":"filterSameChange","tag":{"cn":"当两次选择的值相同时不触发onChange","en":"onChange is not triggered when two selected values are the same","default":"false","version":""},"required":false,"type":"boolean "},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"required":false,"type":"string[] "},{"name":"defaultValue","tag":{"cn":"默认值  和 value 类型相同","en":"defaultValue 和 value 类型相同","default":"","version":""},"required":false,"type":"Value "},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"required":false,"type":"boolean "},{"name":"rules","tag":{"cn":"校验规则 详见 [Rule](/components/rule)","en":"Validation rules, see [Rule](/components/rule) usage for details","default":"","version":""},"required":false,"type":"RuleItem[]"},{"name":"name","tag":{"cn":"表单字段, 配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"required":false,"type":"string "},{"name":"size","tag":{"cn":"尺寸","en":"size","default":"","version":""},"required":false,"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"renderResult","tag":{"cn":"选中后在结果中显示的内容，默认和 renderItem 相同","en":"The content displayed in the result after selecting, if not set, use renderItem. not show while return null, result is current selected","default":"renderItem","version":""},"required":false,"type":"ObjectKey<DataItem> | ((data: DataItem, row: DataItem[]) => ReactNode) "},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "},{"name":"placeholder","tag":{"cn":"占位符","en":"placeholder","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"onFocus","tag":{"cn":"聚焦事件","en":"focus event","default":"","version":""},"required":false,"type":"(e?: FocusEvent ) => void"},{"name":"onBlur","tag":{"cn":"失焦事件","en":"blur event","default":"","version":""},"required":false,"type":"(e?: MouseEvent ) => void"},{"name":"loading","tag":{"cn":"下拉列表加载状态","en":"dropdown list loading state","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"onCollapse","tag":{"cn":"下拉列表展开/收起回调","en":"options collapse callback","default":"","version":""},"required":false,"type":"((collapse: boolean) => void) "},{"name":"tip","tag":{"cn":"提示信息","en":"Prompt information","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"width","tag":{"cn":"输入框宽度","en":"input width","default":"","version":""},"required":false,"type":"string | number "},{"name":"popoverProps","tag":{"cn":"校验弹框接受的属性，具体属性参考 [Popover](/components/Popover)","en":"Vilidate popup properties, specific properties refer to [Popover](/components/Popover)","default":"","version":""},"required":false,"type":"PopoverProps "},{"name":"underline","tag":{"cn":"是否只展示下边框","en":"only display border bottom","default":"false","version":""},"required":false,"type":"boolean "},{"name":"border","tag":{"cn":"是否展示边框","en":"Whether to display border","default":"false","version":""},"required":false,"type":"boolean "},{"name":"onFilter","tag":{"cn":"onFilter 不为空时，可以输入过滤数据\\nonFilter 如果返回一个函数，使用这个函数做前端过滤\\n如果不返回，可以自行做后端过滤\\n单选状态下支持","en":"When the onFilter is not empty, you can filter data by input.\\nIf the onFilter returns a function, use this function as a front-end filter.\\nIf return undefined, you can do your own backend filtering.\\nsupport in single selection state","default":"","version":""},"required":false,"type":"((text: string) => void | ((data: DataItem) => boolean) ) "},{"name":"childrenKey","tag":{"cn":"指定子数据的属性名","en":"the key of the children data name","default":"\\\"children\\\"","version":""},"required":false,"type":"ObjectKey<DataItem> "},{"name":"absolute","tag":{"cn":"为 true 时，选项弹出层在 DOM 中独立 render; 为函数时，返回值作为弹出层容器","en":"When it is true, the pop-up layer of option append into document.body; When it is a function, the return value is used as the popup layer container","default":"false","version":""},"required":false,"type":"boolean | (() => HTMLElement) "},{"name":"zIndex","tag":{"cn":"选项列表 z-index 值, 需要配合 absolute","en":"options z-index should use with absolute","default":"1000","version":""},"required":false,"type":"number "},{"name":"innerTitle","tag":{"cn":"内嵌标题","en":"inner title","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"mode","tag":{"cn":"选中值模式，未设置值为单选 0: 只返回完全选中的节点，包含父节点 1: 返回全部选中的节点和半选中的父节点 2: 只返回选中的子节点 3: 如果父节点选中，只返回父节点 4: 所选即所得","en":"mode 0: Returns only the fully selected node including the parent node. 1: Returns all selected nodes and semi-selected nodes. 2: Return only the selected child nodes. 3: If the parent node is full selected, only return the parent node. 4: What you choose is what you get.","default":"","version":""},"required":false,"type":"0 | 1 | 2 | 3 | 4 "},{"name":"renderOptionList","tag":{"cn":"自定义渲染下拉列表","en":"Custom render dropdown","default":"","version":""},"required":false,"type":"((list: ReactElement, info: { loading: boolean; }) => ReactElement) "},{"name":"renderUnmatched","tag":{"cn":"渲染未匹配值的方式","en":"Custom rendering unmatched values","default":"","version":""},"required":false,"type":"((data: any) => ReactNode) "},{"name":"open","tag":{"cn":"控制浮层显隐","en":"Set visible of cascader popup","default":"","version":""},"required":false,"type":"boolean "},{"name":"data","tag":{"cn":"数据","en":"data","default":"","version":""},"required":false,"type":"any[]"},{"name":"height","tag":{"cn":"下拉列表高度","en":"height of dropdown options","default":"300","version":""},"required":false,"type":"number "},{"name":"unmatch","tag":{"cn":"是否展示data中不存在的值","en":"render unmatch value","default":"true","version":""},"required":false,"type":"boolean "},{"name":"clearable","tag":{"cn":"是否显示清除数据图标","en":"If clearable is true, show clear value icon","default":"true","version":""},"required":false,"type":"boolean "},{"name":"wideMatch","tag":{"cn":"开启 wideMatch 后，将筛选出所有可能的匹配项目","en":"Allows all possible matching options to be choosed","default":"false","version":""},"required":false,"type":"boolean "},{"name":"showArrow","tag":{"cn":"是否显示下拉箭头，仅针对单选情况","en":"show dropdown arrow, only single select","default":"true","version":""},"required":false,"type":"boolean "},{"name":"finalDismiss","tag":{"cn":"选择末级节点后是否关闭选项列表","en":"close options after chose the final node","default":"false","version":""},"required":false,"type":"boolean "},{"name":"singleRemove","tag":{"cn":"支持单个节点删除","en":"Support single node deletion","default":"none","version":""},"required":false,"type":"boolean "},{"name":"compressedBound","tag":{"cn":"开启多选后，指定允许展示标签数量，超过后将折叠","en":"when compressed is True,the comptessedBound can limit the numbers of multiple selected item\\\"s label","default":"","version":""},"required":false,"type":"number "},{"name":"compressed","tag":{"cn":"将选中值合并","en":"Merges selected values","default":"false","version":""},"required":false,"type":"boolean | \\\"no-repeat\\\" "},{"name":"loader","tag":{"cn":"设置loader属性后，未定义children的节点视为动态加载节点，点击展开触发 loader事件，children 为 null 或者长度为 0 视为叶子节点","en":"If the loader attribute is a function, the node with no children is regarded as dynamically loaded node. Click expanded button to trigger the loader event. The children property is null or its length is 0 will be regarded as a leaf node.","default":"","version":""},"required":false,"type":"((key: string | number, data: DataItem) => void) "},{"name":"expandTrigger","tag":{"cn":"节点展开触发方式","en":"Expand mode","default":"\\\"click\\\"","version":""},"required":false,"type":"\\\"hover\\\" | \\\"click\\\" | \\\"hover-only\\\" "},{"name":"keygen","tag":{"cn":"生成key的辅助方法, 为函数时，使用此函数返回值, 为string时，使用这个string对应的数据值。如 \\\"id\\\"，相当于 (d) => d.id","en":"Auxiliary method for generating key. When it is a function, use the return value of this function. When it is a string, use the data value corresponding to this string. For example, \\\"id\\\" is the same thing as (d) => d.id.","default":"index","version":""},"required":true,"type":"ObjectKey<DataItem> | ((data: DataItem, parentKey?: string | number ) => string | number)"},{"name":"getComponentRef","tag":{"cn":"绑定组件的引用, 可以调用某些组件的方法","en":"A reference to the binding component, you can call some component methods","default":"","version":""},"required":false,"type":"((comp: ComponentRef) => void) | { current: ComponentRef ; } "},{"name":"renderItem","tag":{"cn":"为 string 时，返回 d\\\\[string]。 为 function 时，返回函数结果","en":"When it is a string, return d[string]. When it is a function, return the result of the function.","default":"d => d","version":""},"required":true,"type":"ObjectKey<DataItem> | ((data: DataItem, active?: boolean , id?: Value[0] ) => ReactNode)"}],"cn":"","en":""},{"title":"CascaderRef","isDetail":"true","properties":[{"name":"close","tag":{"cn":"关闭下拉框","en":"Close the drop-down box","default":"","version":""},"required":true,"type":"(e?: MouseEvent ) => void"}],"cn":"","en":""}]';
