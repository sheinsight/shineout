...
const api = '[{"title":"Alert","properties":[{"name":"children","tag":{"cn":"内容，文字或react组件","en":"Content, text or react component","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"icon","tag":{"cn":"为true时，根据type属性显示状态图标。如果需要显示自定义图标，传入ReactElement。","en":"When the type is true, the status icon is displayed according to the type property. If you need to display a custom icon, pass in ReactElement.","default":"","version":""},"required":false,"type":"boolean | ReactElement "},{"name":"iconSize","tag":{"cn":"icon 的尺寸","en":"The size for icon","default":"14","version":""},"required":false,"type":"number "},{"name":"onClose","tag":{"cn":"当onClose 为空时，不显示关闭。如果需要关闭又不需要处理回调，设置为true即可","en":"When onClose is empty, no close is displayed. If you need to close and do not need to handle callbacks, set it true.","default":"","version":""},"required":false,"type":"boolean | ((duration?: number , offsetHeight?: number ) => void) "},{"name":"type","tag":{"cn":"类型","en":"types","default":"","version":""},"required":false,"type":"\\\"error\\\" | \\\"success\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"info\\\" | \\\"confirmwarning\\\" "},{"name":"hideClose","tag":{"cn":"是否隐藏关闭按钮","en":"show close button","default":"false","version":""},"required":false,"type":"boolean "},{"name":"closeItem","tag":{"cn":"custom close button","en":"自定义关闭按钮","default":"","version":""},"required":false,"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展 className","en":"extend className","default":"","version":""},"required":false,"type":"string "},{"name":"style","tag":{"cn":"最外层扩展样式","en":"Container element style","default":"","version":""},"required":false,"type":"CSSProperties "}],"cn":"","en":""}]';
