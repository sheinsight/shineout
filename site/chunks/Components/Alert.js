...
const api = '[{"title":"Alert","properties":[{"name":"children","tag":{"en":"Content, text or react component","cn":"内容，文字或react组件"},"type":"ReactNode"},{"name":"icon","tag":{"en":"When the type is true, the status icon is displayed according to the type property. If you need to display a custom icon, pass in ReactElement.","cn":"为true时，根据type属性显示状态图标。如果需要显示自定义图标，传入ReactElement。"},"type":"boolean | ReactElement"},{"name":"iconSize","tag":{"en":"The size for icon","cn":"icon 的尺寸","default":"14"},"type":"number"},{"name":"onClose","tag":{"en":"When onClose is empty, no close is displayed. If you need to close and do not need to handle callbacks, set it true.","cn":"当onClose 为空时，不显示关闭。如果需要关闭又不需要处理回调，设置为true即可"},"type":"boolean | ((duration?: number , offsetHeight?: number ) => void)"},{"name":"type","tag":{"en":"types","cn":"类型"},"type":"\\\"success\\\" | \\\"info\\\" | \\\"warning\\\" | \\\"danger\\\" | \\\"error\\\" | \\\"confirmwarning\\\""},{"name":"hideClose","tag":{"en":"show close button","cn":"是否隐藏关闭按钮","default":"false"},"type":"boolean"},{"name":"outAnimation","tag":{"inner":""},"type":"boolean"},{"name":"closeItem","tag":{"cn":"custom close button","en":"自定义关闭按钮"},"type":"ReactNode"},{"name":"dismiss","tag":{"inner":""},"type":"boolean"},{"name":"duration","tag":{"inner":""},"type":"number"},{"name":"className","tag":{"en":"extend className","cn":"扩展className"},"type":"string"},{"name":"style","tag":{"en":"style object","cn":"内联样式"},"type":"CSSProperties"}]}]';
