...
const api = '[{"title":"Form","properties":[{"name":"onChange","tag":{"cn":"表单内组件值变化函数","en":"callback function, executed when the value is changing","default":"","version":""},"type":"(value: Value) => void"},{"name":"value","tag":{"cn":"表单数据","en":"Form value","default":"","version":""},"type":"object"},{"name":"initValidate","tag":{"cn":"设置 value 后是否自动校验","en":"validate after set value","default":"","version":""},"type":"boolean"},{"name":"defaultValue","tag":{"cn":"Form 默认值","en":"Form default value","default":"","version":""},"type":"object"},{"name":"removeUndefined","tag":{"cn":"是否删除值为 undefined 的字段，默认值为删除","en":"When removeUndefined is true, remove undefined value on submit.","default":"true","version":""},"type":"boolean"},{"name":"rules","tag":{"cn":"校验规则","en":"Validation rules","default":"","version":""},"type":"object"},{"name":"disabled","tag":{"cn":"是否禁用，为 true 时，表单内所有元素 disabled 都为 true","en":"When disabled is true, all the elements in the form are disabled.","default":"false","version":""},"type":"boolean"},{"name":"labelAlign","tag":{"cn":"默认为空，跟随主题样式。","en":"The default is empty, follow the theme style.","default":"","version":""},"type":"\\\"top\\\" | \\\"left\\\" | \\\"right\\\""},{"name":"labelVerticalAlign","tag":{"cn":"默认顶部对齐","en":"the default value is top.","default":"\\\"top\\\"","version":""},"type":"\\\"top\\\" | \\\"middle\\\" | \\\"bottom\\\""},{"name":"size","tag":{"cn":"表单元素的尺寸","en":"Form element size","default":"\\\"default\\\"","version":""},"type":"\\\"small\\\" | \\\"default\\\" | \\\"large\\\""},{"name":"labelWidth","tag":{"cn":"标签宽度，labelAlign 为 \\\"top\\\" 时无效。","en":"The width of label. It is invalid when labelAlign is \\\"top\\\".","default":"140px","version":""},"type":"string | number"},{"name":"mode","tag":{"cn":"模式，和 useMode 配合使用","en":"mode, with useMode","default":"","version":""},"type":"string"},{"name":"keepErrorHeight","tag":{"cn":"单行错误提示不撑开页面高度","en":"Single-line error prompt will not stretch the page height","default":"false","version":""},"type":"boolean"},{"name":"children","tag":{"cn":"Form 内容","en":"Form Content","default":"","version":""},"type":"ReactNode"},{"name":"inline","tag":{"cn":"是否水平布局","en":"When inline is true, the form is horizontal layout","default":"false","version":""},"type":"boolean"},{"name":"onError","tag":{"cn":"异常回调处理","en":"callback when the error happens","default":"","version":""},"type":"(e: Error) => void"},{"name":"onReset","tag":{"cn":"校验规则","en":"Validation rules","default":"","version":""},"type":"() => void"},{"name":"onSubmit","tag":{"cn":"表单提交函数。表单内部校验失败时不会触发。","en":"the function for Form Submission.  When the internal validation fails, it will not be triggered.","default":"","version":""},"type":"(data: Value, detail?: any, event?: Event ) => void"},{"name":"scrollToError","tag":{"cn":"校验失败时是否滚动到第一个校验失败组件，该值为数字时，表示相对于顶部的偏移量","en":"When the verification fails, whether to scroll to the first verification failure component, when the value is a number, it means the offset relative to the top","default":"false","version":""},"type":"number | boolean"},{"name":"throttle","tag":{"cn":"ms, 两次提交间隔时长（防止重复提交）","en":"ms, the interval between two submissions(Prevent repeat submission)","default":"1000","version":""},"type":"number"},{"name":"formRef","tag":{"cn":"绑定 form 的引用, 可以调用某些 form 的方法","en":"bind form ref, Can call some form methods","default":"","version":""},"type":"((form: FormRef<Value>) => void) | { current?: FormRef<Value> ; }"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":"","version":""},"type":"CSSProperties"}],"cn":"","en":""},{"title":"From.Item","properties":[{"name":"labelAlign","tag":{"cn":"默认为空，跟随主题样式。","en":"The default is empty, follow the theme style.","default":"","version":""},"type":"\\\"top\\\" | \\\"left\\\" | \\\"right\\\""},{"name":"labelVerticalAlign","tag":{"cn":"标签垂直方向对齐方式","en":"label vertical align","default":"\\\"top\\\"","version":""},"type":"\\\"top\\\" | \\\"middle\\\" | \\\"bottom\\\""},{"name":"labelWidth","tag":{"cn":"标签宽度，labelAlign 为 \\\"top\\\" 时无效。","en":"The width of label. It is invalid when labelAlign is \\\"top\\\".","default":"140px","version":""},"type":"string | number"},{"name":"keepErrorHeight","tag":{"cn":"单行错误提示不撑开页面高度","en":"Single-line error prompt will not stretch the page height","default":"false","version":""},"type":"boolean"},{"name":"children","tag":{"cn":"表单元素","en":"form element","default":"","version":""},"type":"ReactNode"},{"name":"className","tag":{"cn":"扩展className","en":"extend className","default":"","version":""},"type":"string"},{"name":"style","tag":{"cn":"内联样式","en":"style object","default":"","version":""},"type":"CSSProperties"},{"name":"label","tag":{"cn":"未定义时，标签不会render，也不会占位。如果无内容需要占位，使用空字符串 \\\"\\\"。","en":"When it is undefined, the tag does not be rendered or occupy space. If there is no content, but it needs to be occupied, you can use an empty string \\\"\\\".","default":"","version":""},"type":"ReactNode"},{"name":"required","tag":{"cn":"必填标记，纯展示用，不会触发校验","en":"Required tags for pure display. Do not trigger validation","default":"false","version":""},"type":"boolean"},{"name":"tip","tag":{"cn":"提示文案","en":"Prompting information","default":"","version":""},"type":"ReactNode"}],"cn":"表单项，主要用来布局，显示标签，提示文案信息等","en":"Used to layout, display labels, tips, errors, etc"},{"title":"Form.Field","properties":[{"name":"defaultValue","tag":{"cn":"默认值","en":"defaultValue","default":"","version":""},"type":"any"},{"name":"rules","tag":{"cn":"校验规则 详见 Rule 用法","en":"Validation rules, see Rule usage for details","default":"","version":""},"type":"RuleItem[]"},{"name":"children","tag":{"cn":"支持 value 和 onChange 的 React 组件，或者函数，函数object属性如下\\nvalue: 根据 name 从上级 Form 或 Form.Block 获取的值\\nerror：数据校验错误信息，类型为 Error\\nonChange: 值改变回调函数\\ndisabled: 继承 Form 的 disabled 属性","en":"React components that support value and onChange or function. The function object attribute is as follows:\\nvalue: The value obtained from the parent Form or Form.Block by name.\\nerror: the error information of data validation. type is Error.\\nonChange: The callback when the value is changing.\\ndisabled: inherit the disabled attribute of Form.","default":"","version":""},"type":"((opts: object) => ReactNode) | ReactNode"},{"name":"onError","tag":{"cn":"rules 校验回调","en":"rules validation callback","default":"","version":""},"type":"(e?: Error ) => void"},{"name":"beforeChange","tag":{"cn":"值改变前的回调，当返回值不为空时将作为组件的新值","en":"The callback before the value is changed, when the return value is not empty, it will be used as the new value of the component","default":"","version":""},"type":"(value: any , datum?: FormDatum) => any"},{"name":"filterSameChange","tag":{"cn":"当两次选择的值相同时不触发onChange","en":"onChange is not triggered when two selected values are the same","default":"false","version":""},"type":"boolean"},{"name":"bind","tag":{"cn":"当值改变是会联动校验 bind 中的字段, 需要配合Form 使用","en":"When the value changes, it will link to verify the fields in the bind, which needs to be used with Form","default":"","version":""},"type":"string[]"},{"name":"reserveAble","tag":{"cn":"设置为true 组件卸载后表单不自动删除数据","en":"If set to true, the form will not automatically delete the data after the component is uninstalled","default":"","version":""},"type":"boolean"},{"name":"name","tag":{"cn":"表单字段,配合 Form 使用","en":"Form field, used with Form","default":"","version":""},"type":"string | string[]"}],"cn":"用于处理自定义表单组件，使自定义表单组件实现通过rules校验，存储数据功能","en":"Used to handle custom form components, enabling custom form components to get/store/validate value from formdata by name."},{"title":"Form.FieldSet","properties":[{"name":"defaultValue","tag":{"cn":"默认值","en":"default Value","default":"","version":""},"type":"Value[]"},{"name":"rules","tag":{"cn":"校验规则","en":"Validation rules","default":"","version":""},"type":"RuleItem[]"},{"name":"children","tag":{"cn":"children 不为 function，用来处理 object 类型数据，children 内的 name 会拼接 FieldSet name，如 FieldSet name 为 \\\"a\\\", children 元素name 为 b，children 实际处理的数据为 a.b;\\nchildren 为 function 时，用来处理数组数据。options 属性为\\nlist: name 下的全部数据。\\nvalue: 根据name获取的值的单条数据。\\nonChange: 子组件数据改变回调。\\nonRemove: 子组件删除回调。\\nindex: 当前项索引。\\nonInsert: 在当前项之前插入一条数据。\\nonAppend: 在当前项之后附加一条数据。","en":"When children type is not function, handle a set data type of object\\nWhen children type is function, handle a group of data type of array. options property:\\nlist: all data of name.\\nvalue: a single piece of data for the value obtained by name.\\nonChange: a callback when the value is changing.\\nonRemove: a callback when a child component is removed.\\nindex: the current index.\\nonInsert: Insert a piece of data before the current item.\\nonAppend: Insert a piece of data after the current item.","default":"","version":""},"type":"((opts: object) => ReactNode) |ReactNode"},{"name":"name","tag":{"cn":"从 Form 中存取数据的名称","en":"The name that accesses data from from","default":"","version":""},"type":"string"},{"name":"empty","tag":{"cn":"数据为空时展示内容。（仅在children为function时有效）","en":"Show content when data is empty. (only valid when children is function)","default":"","version":""},"type":"(onInsert: (value: Value) => void) => ReactNode"}],"cn":"用来处理 object 类型 字段和数组。","en":"Handle a set(group) data from form by name"},{"title":"Form.Flow","properties":[{"name":"children","tag":{"cn":"datum 为 Datum.Form 对象","en":"datum is the object of Datum.Form.","default":"","version":""},"type":"(datum: FormDatum) => ReactNode"},{"name":"names","tag":{"cn":"names 为空时，Form 内任意值变化会触发 Flow 更新；不为空时，只监听指定字段变化","en":"Specifying which fields to change trigger the Flow update.","default":"","version":""},"type":"string[]"}],"cn":"","en":""},{"title":"FormRef","properties":[{"name":"getValue","tag":{"cn":"返回表单的值","en":"return form value","default":"","version":"1.4.4"},"type":"() => Value"},{"name":"validate","tag":{"cn":"校验表单","en":"Validate form","default":"","version":"1.4.4"},"type":"() => Promise<any>"},{"name":"validateFields","tag":{"cn":"校验表单指定字段","en":"Validation form fields","default":"","version":"1.7.1"},"type":"(fields: string | string[]) => Promise<any>"},{"name":"validateFieldsWithError","tag":{"cn":"校验可以通过 catch 获取报错信息","en":"The verification can get the error message through Promise.catch","default":"","version":"1.7.3"},"type":"(fields: string | string[]) => Promise<any>"},{"name":"clearValidate","tag":{"cn":"清除校验","en":"Clear check","default":"","version":"1.4.4"},"type":"() => void"},{"name":"submit","tag":{"cn":"提交表单, withValidate: 是否校验","en":"Submit Form, withValidate: Whether to verify","default":"","version":"1.4.4"},"type":"(withValidate?: boolean ) => void"},{"name":"reset","tag":{"cn":"重置表单","en":"reset form","default":"","version":"1.4.4"},"type":"() => void"}],"cn":"Form 实例的一些方法","en":"Form instance method"}]';
