...
declare class UploadImage extends React.Component<UploadImageProps, {}> {
  render(): JSX.Element;
}
...
export interface UploadProps {
  ...
  /**
   * The key access data in the Form
   * Form 内存取数据的 key
   * default: none
   */
  name?: string;
   ...
   * default: none
   */
  onSuccess?: (res: string, file: File, data: any, xhr: any) => any;
   ...
   * default: -
   */
  renderContent?: (res: any, value: any, index: number, values: any[]) => ReactNode;
