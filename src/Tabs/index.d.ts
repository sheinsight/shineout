...
export interface TabsLinkProps extends AnchorHTMLAttributes<any>, StandardProps {
  /**
   * Link content
   *
   * 链接内容
...
declare class TabsLink extends React.Component<TabsLinkProps> {
  render(): JSX.Element;
}
