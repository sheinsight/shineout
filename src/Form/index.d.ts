...
type RuleParamsType<Value> = Array<RuleObjectParams | ((value?: any, formData?: Value, callback?: ((cbArgs: true | Error) => void), props?: any) => void)>
...
declare class FormFieldSet extends React.Component<FormFieldSetProps, {}> {
  render(): JSX.Element;
}
...
declare class Form extends React.Component<FormProps<Value>, {}> {
