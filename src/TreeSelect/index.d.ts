...
import { ListItemStandardProps, StandardProps } from '../@types/common'

type ReactNode = React.ReactNode;



export interface TreeSelectProps<Value, Data> extends StandardProps, ListItemStandardProps<Data, Value> {
  /**
   * show border bottom
   *
   * 仅仅展示下边框
