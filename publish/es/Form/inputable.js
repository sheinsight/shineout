...
var consumer = compose(formConsumer(types), itemConsumer, loopConsumer, fieldSetConsumer);

var tryValue = function tryValue(val, def) {
  return val === undefined ? def : val;
};

var beforeValueChange = curry(function (fn, value, datum) {
  if (!fn) return value;
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      var _this$props10 = this.props,
          ...
          other = _objectWithoutPropertiesLoose(_this$props10, ["formDatum", "value", "required", "loopContext", "bind", "onItemError", "bindInputToItem", "unbindInputFromItem", "scuSkip", "defaultValue", "reserveAble"]);
