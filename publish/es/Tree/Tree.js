...
function (_PureComponent) {
  ...
  function Tree(props) {
    ...
    _this.nodes = new Map();
    _this.datum = props.datum || new DatumTree({
      data: props.data,
      loader: props.loader,
      keygen: props.keygen,
      mode: props.mode,
    ...
    _this.handleDragImageSelector = _this.handleProps.bind(_assertThisInitialized(_assertThisInitialized(_this)), 'dragImageSelector');
    _this.handleClidrenClass = _this.handleProps.bind(_assertThisInitialized(_assertThisInitialized(_this)), 'childrenClass');
    _this.handleLeafClass = _this.handleProps.bind(_assertThisInitialized(_assertThisInitialized(_this)), 'leafClass');
  ...
  _proto.handleDrop = function handleDrop(id, targetId, position) {
    ...
    var data = immer(this.props.data, function (draft) {
      var node = draft;
      var temp;
      var removeNode;
      var offset = 0;
...
Tree.propTypes = _objectSpread({}, getProps(PropTypes), {
