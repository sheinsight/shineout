...
var WrappedOptionList = absoluteList(OptionList);
var WrappedBoxList = absoluteList(BoxList);
var WrappedOptionTree = absoluteList(OptionTree);

var isResult = function isResult(el, selector) {
  return getParent(el, selector || "." + selectClass('result'));
};
...
function (_PureComponent) {
  ...
  function Select(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "forceChange", function () {
    ...
    _this.bindOptionFunc = _this.bindOptionFunc.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.handleRemove = _this.handleChange.bind(_assertThisInitialized(_assertThisInitialized(_this)), false);
    _this.handleKeyDown = _this.handleKeyDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleKeyUp = _this.handleKeyUp.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleInputFocus = _this.handleInputFocus.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleControlChange = _this.handleControlChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleClickAway = _this.handleClickAway.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleInputBlur = _this.handleInputBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.bindFocusInputFunc = _this.bindFocusInputFunc.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleFilter = _this.handleFilter.bind(_assertThisInitialized(_assertThisInitialized(_this))); // this.toInputTriggerCollapse = this.toInputTriggerCollapse.bind(this)

    _this.renderItem = _this.renderItem.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.renderResult = _this.renderResult.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleDelete = _this.handleDelete.bind(_assertThisInitialized(_assertThisInitialized(_this))); // option list not render till first focused

    _this.renderPending = true;
    _this.optionList = {};
    _this.selectId = "select_" + getUidStr(); // this.closeByResult = false
  ...
  _proto.renderCustomHeader = function renderCustomHeader() {
    ...
    if (React.isValidElement(header)) return React.createElement("div", {
      className: selectClass('custom-header')
    }, header);
    return null;
  };
  ...
  _proto.renderTree = function renderTree() {
    ...
    return React.createElement(WrappedOptionTree, _extends({
  ...
  _proto.render = function render() {
    ...
    var className = selectClass('inner', size, this.state.focus && 'focus', this.state.position, multiple && 'multiple', disabled === true && getDirectionClass('disabled'), !trim && 'pre');
...
Select.propTypes = _objectSpread({}, getProps(PropTypes, 'placehodler', 'keygen'), {
