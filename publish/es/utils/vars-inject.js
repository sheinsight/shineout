...
export function injectTag(custom) {
  ...
  var styleText = "body{" + Object.keys(_objectSpread({}, styleObj, custom)).map(function (key) {
...
function setBodyProperty(colors, value) {
  for (var _iterator = entries(colors), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    var _ref;
