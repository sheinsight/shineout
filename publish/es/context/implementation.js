...
function createReactContext(defaultValue, calculateChangedBits) {
  ...
  function (_Component) {
    ...
    function Provider() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitter", createEventEmitter(_this.props.value));
  ...
  function (_Component2) {
    ...
    function Consumer() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "observedBits", void 0);

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "state", {
        value: _this2.getValue()
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "onUpdate", function (newValue, changedBits) {
