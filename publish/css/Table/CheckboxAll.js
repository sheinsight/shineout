...
/*#__PURE__*/
function (_Component) {
  (0, _inheritsLoose2.default)(TableCheckboxAll, _Component);
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    if (!(0, _shallowEqual.default)(this.props, nextProps)) return true;
  ...
  _proto.getFilterData = function getFilterData() {
    ...
    if (data && filterAll && Array.isArray(data) && (0, _is.isFunc)(filterAll)) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(_Checkbox.default, (0, _extends2.default)({}, this.props, {
...
exports.default = TableCheckboxAll;
(0, _defineProperty2.default)(TableCheckboxAll, "propTypes", {
