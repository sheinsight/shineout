...
exports.entries = exports.deepHas = exports.deepRemove = exports.deepGet = exports.deepSet = exports.deepMerge = exports.objectValues = void 0;
...
var deepSet = function deepSet(target, path, value, options) {
  if (options === void 0) {
    options = {};
  }
  ...
  for (var _iterator = pathGenerator(path), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    ...
    if (options.forceSet) {
      ...
      current[prop] = (0, _is.isMergeable)(current[prop]) && (0, _is.isMergeable)(value) ? deepMerge(current[prop], value, mergeOptions) : value;
    }
...
var deepGet = function deepGet(target, path, options) {
  if (options === void 0) {
    options = {};
  }
