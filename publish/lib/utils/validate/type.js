...
var regs = {
  ...
  get rgb() {
    return new RegExp('^rgb\\(\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])\\s*,\\s*(0|[1-9]\\d?|1\\d\\d?|2[0-4]\\d|25[0-5])\\s*\\)$');
  },
...
var _default = function _default(type, message) {
  return (0, _nullable.default)(function (value, formdata, callback) {
    var error = new Error(message);

    if (type === 'json') {
      if ((0, _isJson.default)(value)) callback(true);else callback(error);
      return;
    }
